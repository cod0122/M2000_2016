		...
		if k_risposta_load_memo_link = 3 then
			...
			if a_file_nr > 0 then
				...
				if k_risposta_load_memo_link = 1 then
					kst_tab_memo_link.memo_link_load = kuf1_memo_link.kki_memo_link_load_si
				else
					kst_tab_memo_link.memo_link_load = kuf1_memo_link.kki_memo_link_load_NO
				end if
				kuf1_memo_link.u_add_memo_link(kst_tab_memo_link, a_file[])
			end if

...
public constant string kki_status_ready_toschedule_descr = "Barcode Associati pronti alla Pianificazione"  	// etichette associate (label matched) pronte per la pianificazione

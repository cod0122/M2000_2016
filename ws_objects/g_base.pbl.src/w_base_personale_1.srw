...
type dw_print_0 from w_base_personale`dw_print_0 within w_base_personale_1
end type
...
type cb_logerr from w_base_personale`cb_logerr within tabpage_3
end type

type cb_informix from w_base_personale`cb_informix within tabpage_3
end type

type cb_config_ini from w_base_personale`cb_config_ini within tabpage_3
end type
...
type st_cb_protemail from w_base_personale`st_cb_protemail within tabpage_9
end type

type cb_protemail from w_base_personale`cb_protemail within tabpage_9
end type

type st_cb_prototipi from w_base_personale`st_cb_prototipi within tabpage_9
end type

type cb_prototipi from w_base_personale`cb_prototipi within tabpage_9
end type

type st_31 from w_base_personale`st_31 within tabpage_9
end type

type st_30 from w_base_personale`st_30 within tabpage_9
end type

type cb_placeholder_l from w_base_personale`cb_placeholder_l within tabpage_9
end type

type st_cb_placeholder_l from w_base_personale`st_cb_placeholder_l within tabpage_9
end type
...
type st_29 from w_base_personale`st_29 within tabpage_10
end type

type cb_aco from w_base_personale`cb_aco within tabpage_10
end type

type st_smart from w_base_personale`st_smart within tabpage_10
end type

type cb_smart from w_base_personale`cb_smart within tabpage_10
end type

...
//
int kki_scelta_report_lotti_entrati
int kki_scelta_report_generico
int kki_scelta_report_coda_pilota
int kki_scelta_report_in_trattamento
int kki_scelta_report_prevFineLav
int kki_scelta_report_trattato
int kki_scelta_report_chk_intra
int kki_scelta_report_RegArt50
int kki_scelta_report_lotti_in_giacenza
int kki_scelta_report_lotti_in_giacenza_gia_trattati 
int kki_scelta_report_lotti_da_sped 
int kki_scelta_report_lotti_sped 
int kki_scelta_report_etichette_lotti 
int kki_scelta_report_etichettine 
int kki_scelta_report_groupage 
int kki_scelta_report_bcode_trattati 
int kki_scelta_report_memo 
//int kki_scelta_report_lotti_sped_dafatt 
int kki_scelta_report_attestati 
int kki_scelta_report_art_movim 
int kki_scelta_report_armo_Contratti 
int kki_scelta_report_LavxCapitolato 
int kki_scelta_report_nrdosimetri 
int kki_scelta_report_colliParziali 
int kki_scelta_report_RunsRtrRts 
int kki_scelta_report_PtasksLab 

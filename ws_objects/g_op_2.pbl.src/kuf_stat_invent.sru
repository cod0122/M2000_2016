...
//--- elabora solo se i parametri di entrata sono cambiati
	...
	//--- costruisco la temp-table dei Trattati e NON 
		...
		k_sql +=  &
				 ...
				 + " and meca.data_ent between '" + string(kast_stat_invent.data_da ) + "' and '"+ string(kast_stat_invent.data_a) + "' " 


		if kast_stat_invent.flag_lotto_chiuso then 
         	k_sql +=  " and ((meca.aperto <> 'N' and meca.aperto <> 'A') or meca.aperto is null) " 
		end if

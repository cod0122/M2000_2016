...
forward
global type w_ddt_free_new_st from w_g_tab_st
end type
...
private int k_ddlb_copie_index=1 //2
end variables
...
type st_ordina_lista from w_g_tab_st`st_ordina_lista within w_ddt_free_new_st
end type

type st_aggiorna_lista from w_g_tab_st`st_aggiorna_lista within w_ddt_free_new_st
end type

type cb_ritorna from w_g_tab_st`cb_ritorna within w_ddt_free_new_st
end type

type st_stampa from w_g_tab_st`st_stampa within w_ddt_free_new_st
end type

type rb_emissione_tutto from w_g_tab_st`rb_emissione_tutto within w_ddt_free_new_st
integer y = 420
end type

type rb_emissione_selezione from w_g_tab_st`rb_emissione_selezione within w_ddt_free_new_st
integer y = 516
end type

type rb_definitiva from w_g_tab_st`rb_definitiva within w_ddt_free_new_st
integer y = 1328
integer width = 878
string text = "EFFETTIVA (Aggiorna Archivi)"
end type

type rb_prova from w_g_tab_st`rb_prova within w_ddt_free_new_st
integer y = 1240
string text = "Solo Ristampa (no Aggiornamenti) "
end type

type pb_ok from w_g_tab_st`pb_ok within w_ddt_free_new_st
integer y = 1740
end type

type dw_documenti from w_g_tab_st`dw_documenti within w_ddt_free_new_st
integer height = 1924
string dataobject = "d_sped_free_l5"
end type

type cbx_aggiorna_stato from w_g_tab_st`cbx_aggiorna_stato within w_ddt_free_new_st
integer y = 1432
string text = "Aggiorna lo Stato in ~'Stampato~'"
end type

type cbx_update_profis from w_g_tab_st`cbx_update_profis within w_ddt_free_new_st
boolean visible = false
integer x = 494
integer y = 1964
end type

type st_1 from w_g_tab_st`st_1 within w_ddt_free_new_st
integer y = 1808
end type

type cbx_update_tab_varie from w_g_tab_st`cbx_update_tab_varie within w_ddt_free_new_st
boolean visible = false
integer x = 251
integer y = 1964
end type

type rb_modo_stampa_e from w_g_tab_st`rb_modo_stampa_e within w_ddt_free_new_st
integer y = 944
boolean enabled = false
end type

type rb_modo_stampa_s from w_g_tab_st`rb_modo_stampa_s within w_ddt_free_new_st
integer y = 852
end type
...
type gb_emissione from w_g_tab_st`gb_emissione within w_ddt_free_new_st
integer y = 324
end type

type gb_produzione from w_g_tab_st`gb_produzione within w_ddt_free_new_st
integer y = 744
integer height = 324
end type

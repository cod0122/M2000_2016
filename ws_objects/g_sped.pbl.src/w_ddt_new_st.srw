...
forward
global type w_ddt_new_st from w_g_tab_st
end type
...
private int k_ddlb_copie_index=1 // 20/1/2020  era 2 su richiesta della Frignani
end variables
...
//		kst_tab_sped.id_sped = kist_sped_ddt[1].kst_tab_sped.id_sped 
//		if kst_tab_sped.id_sped > 0 then
//			kuf1_sped.get_cura_trasp(kst_tab_sped)
//			if kst_tab_sped.cura_trasp <> kuf1_sped.kki_cura_trasp_vettore then
//				k_ddlb_copie_index = 1    
//			end if
//		end if
...
//	
	if not m_main.m_strumenti.m_fin_gest_libero8.enabled  then
		m_main.m_strumenti.m_fin_gest_libero8.text = "Stampa d.d.t. bianco "
		m_main.m_strumenti.m_fin_gest_libero8.microhelp = 	"Stampa d.d.t. bianco senza dati  "
		m_main.m_strumenti.m_fin_gest_libero8.visible = true
		m_main.m_strumenti.m_fin_gest_libero8.enabled = true
		m_main.m_strumenti.m_fin_gest_libero8.toolbaritemtext = "Bianco,"+ m_main.m_strumenti.m_fin_gest_libero8.text
		m_main.m_strumenti.m_fin_gest_libero8.toolbaritemname = "Layer!"
...
type st_ordina_lista from w_g_tab_st`st_ordina_lista within w_ddt_new_st
end type

type st_aggiorna_lista from w_g_tab_st`st_aggiorna_lista within w_ddt_new_st
end type

type cb_ritorna from w_g_tab_st`cb_ritorna within w_ddt_new_st
end type

type st_stampa from w_g_tab_st`st_stampa within w_ddt_new_st
integer x = 2130
integer y = 1992
end type

type rb_emissione_tutto from w_g_tab_st`rb_emissione_tutto within w_ddt_new_st
integer x = 78
integer y = 472
integer width = 928
end type

type rb_emissione_selezione from w_g_tab_st`rb_emissione_selezione within w_ddt_new_st
integer x = 78
integer y = 560
end type

type rb_definitiva from w_g_tab_st`rb_definitiva within w_ddt_new_st
integer y = 1328
integer width = 1138
...
type rb_prova from w_g_tab_st`rb_prova within w_ddt_new_st
integer y = 1240
string text = "Solo Ristampa (no Aggiornamenti) "
boolean checked = false
end type

type pb_ok from w_g_tab_st`pb_ok within w_ddt_new_st
integer y = 1712
end type
...
type cbx_aggiorna_stato from w_g_tab_st`cbx_aggiorna_stato within w_ddt_new_st
integer x = 160
integer y = 1428
integer width = 887
...
type cbx_update_profis from w_g_tab_st`cbx_update_profis within w_ddt_new_st
boolean visible = false
integer x = 32
integer y = 2004
end type

type st_1 from w_g_tab_st`st_1 within w_ddt_new_st
integer y = 1780
end type

type cbx_update_tab_varie from w_g_tab_st`cbx_update_tab_varie within w_ddt_new_st
boolean visible = false
integer x = 32
integer y = 2088
end type

type rb_modo_stampa_e from w_g_tab_st`rb_modo_stampa_e within w_ddt_new_st
integer x = 78
integer y = 940
boolean enabled = false
end type

type rb_modo_stampa_s from w_g_tab_st`rb_modo_stampa_s within w_ddt_new_st
integer x = 78
integer y = 848
end type

type cbx_chiude from w_g_tab_st`cbx_chiude within w_ddt_new_st
integer x = 101
integer y = 1588
integer width = 1024
integer height = 92
...
type gb_emissione from w_g_tab_st`gb_emissione within w_ddt_new_st
integer y = 368
integer height = 336
end type

type gb_produzione from w_g_tab_st`gb_produzione within w_ddt_new_st
integer y = 740
end type

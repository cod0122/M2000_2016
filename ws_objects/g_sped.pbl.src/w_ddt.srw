...
private boolean ki_alarm_todo_msg = true
...
private subroutine u_set_dw_riga_0 ()
public subroutine u_message (st_esito ast_esito)
private subroutine u_modifica_check ()
public subroutine u_button_visible (boolean a_visible)
protected subroutine u_popola_dwc ()
...
//--- Se tutto OK aggiorna le righe di dettaglio 	
		...
		choose case k_rc
			...
			case is < 0		
				...
				kguo_exception.setmessage(  &
					"Attenzione è verificato un errore interno al programma. " + &
			...
			case 0
				...
				if ki_st_open_w.flag_modalita = kkg_flag_modalita.modifica then
					...
					kst_esito.sqlerrtext = &
						"Il Documento cercato non è in archivio " + &
						"Id: " + string(kist_tab_sped_orig.id_sped) + " " 
					u_message(kst_esito)
//					kguo_exception.messaggio_utente( )	
					//post close(this)
...
protected subroutine open_start_window ();//
	...
	if dw_anno_numero.object.anno[1] = 0 or isnull(dw_anno_numero.object.anno[1]) then
		dw_anno_numero.object.anno[1]  = year(relativedate(kg_dataoggi, - 15))
	end if
...
//				and tab_1.tabpage_4.enabled then
		...
		if m_main.m_strumenti.m_fin_gest_libero1.enabled <> k_attiva or ki_st_open_w.flag_primo_giro = "S" then 
			...
			m_main.m_strumenti.m_fin_gest_libero1.toolbaritemText = "Lotti, Lotti da Spedire  "
			m_main.m_strumenti.m_fin_gest_libero1.toolbaritembarindex=2
			
			m_main.m_strumenti.m_fin_gest_libero1.enabled = k_attiva
			m_main.m_strumenti.m_fin_gest_libero1.toolbaritemname =  "lotto16x16.gif"
		end if
		...
		if m_main.m_strumenti.m_fin_gest_libero2.enabled <> k_attiva or ki_st_open_w.flag_primo_giro = "S" then 
			...
			m_main.m_strumenti.m_fin_gest_libero2.toolbaritemText = "Materiale, Lotti di Materiale da non trattare da Spedire  "
			m_main.m_strumenti.m_fin_gest_libero2.toolbaritembarindex=2
			
			m_main.m_strumenti.m_fin_gest_libero2.enabled = k_attiva
			m_main.m_strumenti.m_fin_gest_libero2.toolbaritemname =  "lotto16x16_red.gif"
		end if
		...
		if m_main.m_strumenti.m_fin_gest_libero3.enabled <> k_attiva or ki_st_open_w.flag_primo_giro = "S" then
			m_main.m_strumenti.m_fin_gest_libero3.text = "Indica il numero Lotto " 
			m_main.m_strumenti.m_fin_gest_libero3.microhelp = "Compila il ddt con il numero Lotto da spedire"
			m_main.m_strumenti.m_fin_gest_libero3.visible = true

			m_main.m_strumenti.m_fin_gest_libero3.toolbaritemVisible = true
			m_main.m_strumenti.m_fin_gest_libero3.toolbaritemText = 	"Trova, Indica il num. Lotto da spedire"
			m_main.m_strumenti.m_fin_gest_libero3.toolbaritembarindex=2

			m_main.m_strumenti.m_fin_gest_libero3.enabled = k_attiva
			m_main.m_strumenti.m_fin_gest_libero3.toolbaritemName =  "find16.png"
		end if
		...
		if m_main.m_strumenti.m_fin_gest_libero4.enabled <> k_attiva or ki_st_open_w.flag_primo_giro = "S" then
			m_main.m_strumenti.m_fin_gest_libero4.text = "Stampa ddt"
			m_main.m_strumenti.m_fin_gest_libero4.microhelp =  "Stampa ddt"
			m_main.m_strumenti.m_fin_gest_libero4.visible = true
			m_main.m_strumenti.m_fin_gest_libero4.enabled = k_attiva
			m_main.m_strumenti.m_fin_gest_libero4.toolbaritemText = "Stampa,"+m_main.m_strumenti.m_fin_gest_libero4.text
			m_main.m_strumenti.m_fin_gest_libero4.toolbaritemName = "printa16.png" //kGuo_path.get_risorse() + kkg.path_sep
...
//		this.settoolbar( 2, false)
		...
		m_main.m_strumenti.m_fin_gest_libero1.toolbaritemVisible = false
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemVisible = false
...
tab_1.tabpage_1.dw_1.setitem( 1, "loc_1", trim(kst_tab_clienti.loc_1) )
...
if trim(kst_tab_clienti.rag_soc_20) > " " then
	tab_1.tabpage_1.dw_1.setitem( 1, "rag_soc_1", trim(kst_tab_clienti.rag_soc_20) )
	tab_1.tabpage_1.dw_1.setitem( 1, "rag_soc_2", trim(kst_tab_clienti.rag_soc_21) )
else
	tab_1.tabpage_1.dw_1.setitem( 1, "rag_soc_1", trim(kst_tab_clienti.rag_soc_10) )
	tab_1.tabpage_1.dw_1.setitem( 1, "rag_soc_2", trim(kst_tab_clienti.rag_soc_11) )
end if
if trim(kst_tab_clienti.indi_2) > " " then
	tab_1.tabpage_1.dw_1.setitem( 1, "indi", trim(kst_tab_clienti.indi_2) )
	tab_1.tabpage_1.dw_1.setitem( 1, "cap", trim(kst_tab_clienti.cap_2) )
	tab_1.tabpage_1.dw_1.setitem( 1, "loc", trim(kst_tab_clienti.loc_2) )
	tab_1.tabpage_1.dw_1.setitem( 1, "prov", trim(kst_tab_clienti.prov_2) )
	tab_1.tabpage_1.dw_1.setitem( 1, "id_nazione", trim(kst_tab_clienti.id_nazione_2) )
else
	tab_1.tabpage_1.dw_1.setitem( 1, "indi", trim(kst_tab_clienti.indi_1) )
	tab_1.tabpage_1.dw_1.setitem( 1, "cap", trim(kst_tab_clienti.cap_1) )
	tab_1.tabpage_1.dw_1.setitem( 1, "loc", trim(kst_tab_clienti.loc_1) )
	tab_1.tabpage_1.dw_1.setitem( 1, "prov", trim(kst_tab_clienti.prov_1) )
	tab_1.tabpage_1.dw_1.setitem( 1, "id_nazione", trim(kst_tab_clienti.id_nazione_1) )
end if
...
if k_riga > 0 then
	tab_1.tabpage_1.dw_1.setitem(1, "nazioni_nome", trim(kdwc_1.getitemstring(k_riga, "nome")))
else
...
//--- scelta da elenco Indirizzo
			case  kiuf_sped.kki_d_sped_l_indirizzi 
...
if ast_tab_sped_vettori.id > 0 then
	tab_1.tabpage_1.dw_1.setitem(1, "vett_1", trim(ast_tab_sped_vettori.rag_soc_1) )
	if trim(ast_tab_sped_vettori.rag_soc_2) > " " then
		tab_1.tabpage_1.dw_1.setitem(1, "vett_2", trim(ast_tab_sped_vettori.rag_soc_2) )
	end if
else
...
if k_riga > 0 then
	tab_1.tabpage_1.dw_1.setitem(1, "causale", trim(kdwc_1.getitemstring(k_riga, "des")) )
else
...
if trim(ki_st_open_w.flag_modalita) = kkg_flag_modalita.modifica or trim(ki_st_open_w.flag_modalita) = kkg_flag_modalita.inserimento then
	...
	if ast_tab_sped.cura_trasp <> "V" then // se diverso da VETTORE allora protegge i campi
		...
		tab_1.tabpage_1.dw_1.setitem(1, "vett_1", " ")
		tab_1.tabpage_1.dw_1.setitem(1, "vett_2", " ")
		tab_1.tabpage_1.dw_1.u_proteggi_dw("1", "id_vettore")
		tab_1.tabpage_1.dw_1.u_proteggi_dw("1", "vett_1")
		tab_1.tabpage_1.dw_1.u_proteggi_dw("1", "vett_2")
	else
		tab_1.tabpage_1.dw_1.u_proteggi_dw("0", "id_vettore")
		tab_1.tabpage_1.dw_1.u_proteggi_dw("0", "vett_1")
		tab_1.tabpage_1.dw_1.u_proteggi_dw("0", "vett_2")
	end if
...
//--- valorizzo il numero colli dell'intero ddt
	if tab_1.tabpage_1.dw_1.rowcount( ) > 0 then
		...
		if isnull(k_colli_out) then k_colli_out = 0
	...
	try
		...
		if tab_1.tabpage_1.dw_1.rowcount( ) > 0 then
			...
			if kiuf_sped.get_id_sped(kist_tab_sped_orig) > 0 then
				...
				ki_st_open_w.flag_modalita = kkg_flag_modalita.modifica
				u_attiva_tab(1)  // parte INIZIALIZZA()
			else
				if ki_st_open_w.flag_modalita <> kkg_flag_modalita.inserimento then
					ki_st_open_w.flag_modalita = kkg_flag_modalita.inserimento	
					u_attiva_tab(1)  // parte INIZIALIZZA()
...
//		kiuf_sped.get_note(kst_tab_arsp)
		...
		k_riga1 = tab_1.tabpage_4.dw_riga_0.rowcount( )
...
private subroutine u_modifica_check ();//
//======================================================================
//=== Modifica: controlli particolari
//=== 
//======================================================================
//
...
//--- posso modificare il documento?
	if not kiuf_sped.if_modifica(kist_tab_sped) then
		...
		kguo_exception.kist_esito.sqlerrtext = &
			"Attenzione, il DDT non può essere Modificato (ad esempio il lotto è già stato Chiuso). " + &
			"(ID Documento: " + string(kist_tab_sped_orig.id_sped) + ") " 
		throw kguo_exception
	end if

	//--- documento già STAMPATO allora ATTENZIONE alle Modifiche	!!!!!	
	if kiuf_sped.if_stampato(kist_tab_sped) then
		ki_alarm_todo_msg = false   // nel caso non espone il msg di alert
		kguo_exception.kist_esito.esito = kguo_exception.KK_st_uo_exception_tipo_generico
		kguo_exception.kist_esito.sqlerrtext = &
			"Attenzione, DDT già stato Stampato. La Modifica potrebbe comprometterne l'integrità. " + &
			"(ID Documento: " + string(kist_tab_sped_orig.id_sped) + ") " 
		throw kguo_exception
	end if
				 
catch(uo_exception kuo_exception)
	u_message(kuo_exception.kist_esito)
...
public subroutine u_button_visible (boolean a_visible);//
	...
	tab_1.tabpage_1.dw_1.object.p_img_fatturati_x_clie_2.visible = a_visible 
	tab_1.tabpage_1.dw_1.object.p_img_meca_clie_2.visible = a_visible 
	tab_1.tabpage_1.dw_1.object.p_img_indi.visible = a_visible 
	tab_1.tabpage_1.dw_1.object.p_img_note.visible = a_visible 
...
//=== Puntatore Cursore da attesa.....
	...
	if ki_st_open_w.flag_modalita = kkg_flag_modalita.modifica then
	//--- Inabilita alcuni campi alla modifica se giorno di inserimento più vecchio di 2 giorni
		k_data2gg = relativedate(kguo_g.get_dataoggi( ), -2)
		if kist_tab_sped_orig.data_bolla_out < k_data2gg then
			tab_1.tabpage_1.dw_1.u_proteggi_dw("1", "clie_2")
			tab_1.tabpage_1.dw_1.u_proteggi_dw("1", "rag_soc_10")
			tab_1.tabpage_1.dw_1.u_proteggi_dw("1", "p_iva")
			tab_1.tabpage_1.dw_1.u_proteggi_dw("1", "cf")
		end if
...
datawindowchild kdwc_1
	...
	if ki_st_open_w.flag_modalita = kkg_flag_modalita.modifica &
		...
		if kst_tab_sped.clie_2 > 0 then
			...
			tab_1.tabpage_1.dw_1.getchild("note_2", kdwc_1)
...
event close;call super::close;//
	...
	if isvalid(kiuf_report_merce_da_sped) then destroy kiuf_report_merce_da_sped
	if isvalid(kiuf_sped) then destroy kiuf_sped
	if isvalid(kiuf_sped_checkmappa) then destroy  kiuf_sped_checkmappa
...
type dw_print_0 from w_g_tab_3`dw_print_0 within w_ddt
end type
...
event tab_1::u_constructor;//
							// 1     2     3     4     5     6     7     8     9   
ki_tabpage_enabled = {true, false, false, true, true, false, false, false, false} // disabilita alcune tabpage
...
try
	choose case dwo.name 
		...
		case "num_bolla_out", "data_bolla_out"
			this.post modify("data_bolla_out.Background.Color = '" + string(KKG_COLORE.BIANCO) + "' ") 
...
//				kst_tab_sped.num_bolla_out = this.getitemnumber( row, "num_bolla_out")
			...
			if kst_tab_sped.data_bolla_out = kguo_g.get_dataoggi( ) then
				...
				this.post modify("data_bolla_out.Background.Color = '" + string(KKG_COLORE.ERR_DATO) + "' ") 
			end if
			...
			if len(trim(data)) > 0 then 
				if isnumber(trim(data)) then
					...
					if if_anag_attiva(kst_tab_clienti) then
						kst_esito = kiuf_clienti.leggi_rag_soc(kst_tab_clienti)
						if kst_esito.esito = kkg_esito.ok then
							this.post setitem( 1, "meca_rag_soc_10", trim(kst_tab_clienti.rag_soc_10) + " " &
																		+ trim(kst_tab_clienti.rag_soc_11) + " " &
																+ trim(kst_tab_clienti.indi_1) + " " &
																+ trim(kst_tab_clienti.loc_1) + " " &
																+ trim(kst_tab_clienti.prov_1) + " " &
				...
				this.post setitem( 1, "meca_rag_soc_10", " ")
			end if
			...
			if len(trim(data)) > 0 then 
				if isnumber(trim(data)) then
					...
					if if_anag_attiva(kst_tab_clienti) then
						kst_esito = kiuf_clienti.leggi_rag_soc(kst_tab_clienti)
						if kst_esito.esito = kkg_esito.ok then
							this.post setitem( 1, "clie3_rag_soc", trim(kst_tab_clienti.rag_soc_10) + " " &
																		+ trim(kst_tab_clienti.rag_soc_11) + " " &
																+ trim(kst_tab_clienti.indi_1) + " " &
																+ trim(kst_tab_clienti.loc_1) + " " &
																+ trim(kst_tab_clienti.prov_1) + " " &
				...
				this.post setitem( 1, "clie3_rag_soc", " ")
			end if
		...
		case "id_vettore" 
			...
			if len(trim(data)) > 0 then 
				...
				if k_riga > 0 then
					...
					kst_tab_sped_vettori.rag_soc_1 = trim(kdwc_1.getitemstring( k_riga, "rag_soc_1"))
					kst_tab_sped_vettori.rag_soc_2 = trim(kdwc_1.getitemstring( k_riga, "rag_soc_2"))
					post put_video_vett(kst_tab_sped_vettori)
					post event u_setcolumn("vett_1")
				else
					this.post setitem(1, "vett_1", " " )
					this.post setitem(1, "vett_2", " " )
					this.post modify( dwo.name + ".Background.Color = '" + string(KKG_COLORE.ERR_DATO) + "' ") 
				end if
			end if
		case "vett_1" 
			...
			if len(trim(data)) > 0 then 
				...
				if k_riga > 0 then
					...
					this.post setitem(1, "id_vettore", 0)
					this.post modify( dwo.name + ".Background.Color = '" + string(KKG_COLORE.ERR_DATO) + "' ") 
				end if
			end if
		...
		case "id_nazione" 
			...
			if len(trim(data)) > 0 then 
				...
				if k_riga > 0 then
					...
					this.post setitem(1, "nazioni_nome", " " )
					this.post modify( dwo.name + ".Background.Color = '" + string(KKG_COLORE.ERR_DATO) + "' ") 
				end if
			else
				this.post setitem(1, "nazioni_nome", " " )
...
//--- posizionamento della barra orizzontale
		...
		if this.st_orizzontal.y <= 0 then
			this.st_orizzontal.y = this.height/3 - this.st_orizzontal.height 
		end if
...
event u_posiziona ( )
event u_visualizza ( )
event u_resize_old ( boolean a_visible )
event u_resize_false_old ( )
integer x = 37
integer y = 720
integer taborder = 60
...
//
	...
	this.ki_flag_modalita = kkg_flag_modalita.visualizzazione
   tab_1.tabpage_4.dw_riga_0.u_proteggi_sproteggi_dw()
...
event editchanged;// arrivato al 6' numero parte da solo 

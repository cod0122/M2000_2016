...
//
	m_main.m_strumenti.m_fin_gest_libero1.text = "Rigenera Eventi"
...
//--- controlla se utente autorizzato alla funzione in atto
	...
	m_main.m_strumenti.m_fin_gest_libero1.toolbaritemText = "Rigenera,"+m_main.m_strumenti.m_fin_gest_libero1.text
	m_main.m_strumenti.m_fin_gest_libero1.toolbaritemName = "Regenerate!"
...
pointer kpointer  // Declares a pointer variable
	...
	k_rc = MessageBox("Generazione Eventi in schedulazione",&
				"Questa operazione e' distruttiva!" + "~n~r" &
				+ "Tutte gli Eventi in Schedulazione varranno Cancellati e Rigenerati. " + "~n~r" &
...
string dataobject = "d_sv_eventi_sked_l_tree"
...
type st_duplica from w_g_tab0`st_duplica within w_sv_skedulati
end type

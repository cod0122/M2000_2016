$PBExportHeader$w_plav_cfg_proprieta.srw
forward
global type w_plav_cfg_proprieta from w_g_tab_3
end type
...
global w_plav_cfg_proprieta w_plav_cfg_proprieta
...
string k_codice
	...
	if trim(tab_1.tabpage_1.dw_1.getitemstring(1, "cfg_dbms_scelta")) > " " then
		...
		tab_1.tabpage_1.dw_1.setitem(1, "nro_commessa", 1)  // per dafault scelta db 1
	end if
			...
			case 0
				...
				if k_scelta = kkg_flag_modalita.modifica then
					if messagebox("Configurazione DB", &
						"Configurazione " + "(Codice " + trim(k_key) + ") non trovata, vuoi caricarlo ", &
...
on w_plav_cfg_proprieta.create
int iCurrent
call super::create
end on

on w_plav_cfg_proprieta.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_print_0 from w_g_tab_3`dw_print_0 within w_plav_cfg_proprieta
end type

type st_ritorna from w_g_tab_3`st_ritorna within w_plav_cfg_proprieta
integer x = 0
integer y = 0
integer width = 0
integer height = 0
...
type st_ordina_lista from w_g_tab_3`st_ordina_lista within w_plav_cfg_proprieta
integer x = 0
integer y = 0
integer width = 0
integer height = 0
...
type st_aggiorna_lista from w_g_tab_3`st_aggiorna_lista within w_plav_cfg_proprieta
integer x = 0
integer y = 0
integer width = 0
integer height = 0
...
type cb_ritorna from w_g_tab_3`cb_ritorna within w_plav_cfg_proprieta
integer x = 2711
integer y = 1444
integer width = 0
integer height = 0
...
type st_stampa from w_g_tab_3`st_stampa within w_plav_cfg_proprieta
integer x = 0
integer y = 0
integer width = 0
integer height = 0
...
type cb_visualizza from w_g_tab_3`cb_visualizza within w_plav_cfg_proprieta
integer x = 1175
integer y = 1440
integer width = 0
integer height = 0
...
type cb_modifica from w_g_tab_3`cb_modifica within w_plav_cfg_proprieta
integer x = 503
integer y = 1436
integer width = 0
integer height = 0
...
type cb_aggiorna from w_g_tab_3`cb_aggiorna within w_plav_cfg_proprieta
integer x = 1970
integer y = 1444
integer width = 0
integer height = 0
...
type cb_cancella from w_g_tab_3`cb_cancella within w_plav_cfg_proprieta
integer x = 2341
integer y = 1444
integer width = 0
integer height = 0
...
type cb_inserisci from w_g_tab_3`cb_inserisci within w_plav_cfg_proprieta
integer x = 1600
integer y = 1444
integer width = 0
integer height = 0
...
type tab_1 from w_g_tab_3`tab_1 within w_plav_cfg_proprieta
integer x = 0
integer y = 0
integer width = 3040
integer height = 1396
...
integer taborder = 0
string title = ""
string dataobject = "d_plav_conn_cfg"
...
type st_duplica from w_g_tab_3`st_duplica within w_plav_cfg_proprieta
end type

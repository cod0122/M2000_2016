...
forward
global type w_plav_cfg_proprieta from w_db_cfg_proprieta
end type
end forward
...
type dw_print_0 from w_db_cfg_proprieta`dw_print_0 within w_plav_cfg_proprieta
end type

type st_ritorna from w_db_cfg_proprieta`st_ritorna within w_plav_cfg_proprieta
end type

type st_ordina_lista from w_db_cfg_proprieta`st_ordina_lista within w_plav_cfg_proprieta
end type

type st_aggiorna_lista from w_db_cfg_proprieta`st_aggiorna_lista within w_plav_cfg_proprieta
end type

type cb_ritorna from w_db_cfg_proprieta`cb_ritorna within w_plav_cfg_proprieta
end type

type st_stampa from w_db_cfg_proprieta`st_stampa within w_plav_cfg_proprieta
end type

type cb_visualizza from w_db_cfg_proprieta`cb_visualizza within w_plav_cfg_proprieta
end type

type cb_modifica from w_db_cfg_proprieta`cb_modifica within w_plav_cfg_proprieta
end type

type cb_aggiorna from w_db_cfg_proprieta`cb_aggiorna within w_plav_cfg_proprieta
end type

type cb_cancella from w_db_cfg_proprieta`cb_cancella within w_plav_cfg_proprieta
end type

type cb_inserisci from w_db_cfg_proprieta`cb_inserisci within w_plav_cfg_proprieta
end type
...
type tab_1 from w_db_cfg_proprieta`tab_1 within w_plav_cfg_proprieta
...
type st_duplica from w_db_cfg_proprieta`st_duplica within w_plav_cfg_proprieta
end type

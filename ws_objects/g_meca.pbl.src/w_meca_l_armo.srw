...
//
	...
	if NOT m_main.m_strumenti.m_fin_gest_libero3.enabled then
		m_main.m_strumenti.m_fin_gest_libero3.text = "imposta Voci lotto da Fatturare"
		m_main.m_strumenti.m_fin_gest_libero3.microhelp = "imposta Voci riga lotto da Fatturare"
		m_main.m_strumenti.m_fin_gest_libero3.visible = true
		m_main.m_strumenti.m_fin_gest_libero3.enabled = true
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemVisible = true // ki_menu.m_strumenti.m_fin_gest_libero2.enabled
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemText = "Da-Fatt,"+m_main.m_strumenti.m_fin_gest_libero3.text
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemName = "carrello16.png"
...
st_esito kst_esito
	...
	if dw_dett_0.getitemstatus(1, "armo_nt_note_1", primary!) = DataModified! then
	...
	if dw_dett_0.update() <> 1 then
		...
		k_return = "1Errore: " + dw_dett_0.kist_esito.sqlerrtext + " (" + string(dw_dett_0.kist_esito.SQLdbcode) + ")" 
...
try
	...
	kst_tab_meca.data_int = dw_lista_0.getitemdate( 1, "data_int")
...
type st_duplica from w_g_tab0`st_duplica within w_meca_l_armo
end type

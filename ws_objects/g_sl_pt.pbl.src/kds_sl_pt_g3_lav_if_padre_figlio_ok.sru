...
forward
global type kds_sl_pt_g3_lav_if_padre_figlio_ok from ds_db_magazzino_parent
end type
end forward
...
forward prototypes
public function long get_datilav_figlio_if_ok (string a_barcode_figlio, long a_id_sl_pt_g3_lav_padre, integer a_g3ciclo_figlio) throws uo_exception
end prototypes
...
int k_row
		...
		k_row = this.retrieve(a_barcode_figlio, a_id_sl_pt_g3_lav_padre, a_g3ciclo_figlio)

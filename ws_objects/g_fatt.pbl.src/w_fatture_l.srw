...
//
	if not m_main.m_strumenti.m_fin_gest_libero1.visible then
		m_main.m_strumenti.m_fin_gest_libero1.text = "Cambia periodo estrazione fatture " 
		m_main.m_strumenti.m_fin_gest_libero1.microhelp =  "Cambia il periodo di estrazione elenco fatture"
...
//		ki_menu.m_strumenti.m_fin_gest_libero1.toolbaritembarindex=2
		...
		m_main.m_strumenti.m_fin_gest_libero2.text = "Stampa fatture selezionate " 
		m_main.m_strumenti.m_fin_gest_libero2.microhelp =  "Stampa fatture selezionate"
...
//		ki_menu.m_strumenti.m_fin_gest_libero2.toolbaritembarindex=2
		...
		m_main.m_strumenti.m_fin_gest_libero5.text = "Produce Fattura Elettronica (formato XML) " 
...
type st_duplica from w_g_tab0`st_duplica within w_fatture_l
end type

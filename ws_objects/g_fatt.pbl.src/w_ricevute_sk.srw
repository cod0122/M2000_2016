...
//
	...
	if m_main.m_strumenti.m_fin_gest_libero1.enabled <> cb_visualizza.enabled then 
		m_main.m_strumenti.m_fin_gest_libero1.text = "&Togli Riga dalla Lista"
		...
		m_main.m_strumenti.m_fin_gest_libero1.enabled = cb_visualizza.enabled
//		ki_menu.m_strumenti.m_fin_gest_libero1.toolbaritembarindex=2
	end if

	if m_main.m_strumenti.m_fin_gest_libero2.enabled <> cb_visualizza.enabled then 
		m_main.m_strumenti.m_fin_gest_libero2.text = "Crea CIB per la Banca"
		...
		m_main.m_strumenti.m_fin_gest_libero2.enabled = cb_visualizza.enabled
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemtext = &
												 m_main.m_strumenti.m_fin_gest_libero2.text
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemvisible = true
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemname = "RegistrationDir!" //"CreateLibrary!"
//		ki_menu.m_strumenti.m_fin_gest_libero2.toolbaritembarindex=2
	end if
	
	if m_main.m_strumenti.m_fin_gest_libero3.enabled <> cb_visualizza.enabled then
		m_main.m_strumenti.m_fin_gest_libero3.text = "Modifica dati Scadenze"
		...
		m_main.m_strumenti.m_fin_gest_libero3.enabled = cb_visualizza.enabled
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemtext = &
												 m_main.m_strumenti.m_fin_gest_libero3.text
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemvisible = true
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemname = "Open!"

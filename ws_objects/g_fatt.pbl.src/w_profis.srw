...
protected subroutine attiva_menu ();//--- Attiva/Dis. Voci di menu
	...
	if not m_main.m_strumenti.m_fin_gest_libero2.visible then
		m_main.m_strumenti.m_fin_gest_libero2.text = "Mostra/Nascondi Documenti Trasferiti"
		m_main.m_strumenti.m_fin_gest_libero2.microhelp = "Mostra o Nasconde i documenti già esportati verso la Contabilità"
		...
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemText = "Nascondi,"+m_main.m_strumenti.m_fin_gest_libero2.text
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemName = "DeleteRow!"
...
//		ki_menu.m_strumenti.m_fin_gest_libero7.libero1.toolbaritemName = kGuo_path.get_risorse() + KKG.PATH_SEP + "cart_out32.gif"  //"Picture!" // "Destination5!"
		...
		m_main.m_strumenti.m_fin_gest_libero7.libero2.text = "Estrazione Fatture per la Contabilità"
		m_main.m_strumenti.m_fin_gest_libero7.libero2.microhelp =  "Estrazione file movimenti di fatturazione per la Contabilità"

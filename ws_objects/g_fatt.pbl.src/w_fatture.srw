...
boolean ki_display_delete_key_on_menu = true
...
//--- fattura da DDT
		if tab_1.tabpage_1.dw_1.object.fattura_da[1] = kiuf_clienti.kki_fattura_da_bolla then
			m_main.m_strumenti.m_fin_gest_libero1.text = "Elenco DDT spediti da Fatturare " 
//			ki_menu.m_strumenti.m_fin_gest_libero1.toolbaritemname = kguo_path.get_risorse( ) + kkg.path_sep + "bolla.gif"
			m_main.m_strumenti.m_fin_gest_libero1.toolbaritemname = "bolla.gif"
			m_main.m_strumenti.m_fin_gest_libero1.toolbaritemText = "ddt, Spedizioni da Fatturare  "
//--- fattura da Attestato
		elseif tab_1.tabpage_1.dw_1.object.fattura_da[1] = kiuf_clienti.kki_fattura_da_certif then
			m_main.m_strumenti.m_fin_gest_libero1.text = "Elenco Attestati da Fatturare "  
			m_main.m_strumenti.m_fin_gest_libero1.toolbaritemname = "ScriptYes!"
			m_main.m_strumenti.m_fin_gest_libero1.toolbaritemText = "Attestati, Attestati da Fatturare  "
//--- fattura ACCONTI			
		elseif tab_1.tabpage_1.dw_1.object.fattura_da[1] = "A" then 
			m_main.m_strumenti.m_fin_gest_libero1.text = "Elenco Acconti di CO da Fatturare "  
			m_main.m_strumenti.m_fin_gest_libero1.toolbaritemname = "Custom004!"
			m_main.m_strumenti.m_fin_gest_libero1.toolbaritemText = "Acconti, Acconti CO da Fatturare  "
		end if
		if tab_1.tabpage_1.dw_1.object.tipo_doc[1] <> kiuf_fatt.kki_tipo_doc_nota_di_credito then 
			k_attiva = true
		else
...
//			ki_menu.m_strumenti.m_fin_gest_libero1.toolbaritembarindex=2
		...
		if m_main.m_strumenti.m_fin_gest_libero3.enabled <> k_attiva then
			m_main.m_strumenti.m_fin_gest_libero3.text = "Elenco Fatture emesse " 
			m_main.m_strumenti.m_fin_gest_libero3.microhelp = "Elenco Fatture "
			m_main.m_strumenti.m_fin_gest_libero3.visible = true

			m_main.m_strumenti.m_fin_gest_libero3.toolbaritemVisible = true
			m_main.m_strumenti.m_fin_gest_libero3.toolbaritemText = "Fatture, Fatture emesse "
//			ki_menu.m_strumenti.m_fin_gest_libero3.toolbaritembarindex=2

			m_main.m_strumenti.m_fin_gest_libero3.enabled = k_attiva
			m_main.m_strumenti.m_fin_gest_libero3.toolbaritemName = "Custom048!"
		end if
		...
		if m_main.m_strumenti.m_fin_gest_libero4.enabled <> k_attiva then
			m_main.m_strumenti.m_fin_gest_libero4.text = "Aggiungi Riga Libera " 
			m_main.m_strumenti.m_fin_gest_libero4.microhelp = "Aggiungi Riga Libera senza movimentazioni di Magazzino"
			m_main.m_strumenti.m_fin_gest_libero4.visible = true
	
			m_main.m_strumenti.m_fin_gest_libero4.toolbaritemVisible = true
			m_main.m_strumenti.m_fin_gest_libero4.toolbaritemText = 	"Libera, Nuova Riga Libera "
//			ki_menu.m_strumenti.m_fin_gest_libero4.toolbaritembarindex=2
	
			m_main.m_strumenti.m_fin_gest_libero4.enabled = k_attiva
			m_main.m_strumenti.m_fin_gest_libero4.toolbaritemName = "DataManip!"
		end if
		...
		if m_main.m_strumenti.m_fin_gest_libero5.enabled <> k_attiva then
			m_main.m_strumenti.m_fin_gest_libero5.text = "Aggiungi Riga Merce non Trattata " 
			m_main.m_strumenti.m_fin_gest_libero5.microhelp = "Aggiungi Riga Merce senza Lavorazione (no-dose)"
			m_main.m_strumenti.m_fin_gest_libero5.visible = true
	
			m_main.m_strumenti.m_fin_gest_libero5.toolbaritemVisible = true
			m_main.m_strumenti.m_fin_gest_libero5.toolbaritemText = 	"Merce, Nuova Riga senza Trattamento "
...
//			ki_menu.m_strumenti.m_fin_gest_libero5.toolbaritemName = kGuo_path.get_risorse() + "\lotto16x16.gif"
			m_main.m_strumenti.m_fin_gest_libero5.toolbaritemName = "lotto16x16.gif"
		end if
		...
		m_main.m_finestra.m_gestione.m_fin_elimina.toolbaritemvisible = k_attiva

...
st_esito kst_esito
	...
	choose case k_tipo
		...
		case else
			...
			kst_esito.SQLErrText = "Errore interno, tipo di selezione dati di Lavorazione non corretto (tipo=" &
								 + string(k_tipo) + ") "
	...
	choose case k_tipo
		...
		case 1, 2, 3, 4
			...
			if sqlca.sqlcode <> 0 then
				...
				kst_esito.SQLErrText = "Errore in lettura dati di Lavorazioni (ARTR id riga lotto=" &
...
//--- retrive dell'attestato 
		...
		kst_esito.sqlcode = 0
		kst_esito.SQLErrText = "Nessun Attestato da visualizzare: manca il numero documento."
		kst_esito.esito = kkg_esito.bug

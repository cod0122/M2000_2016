...
if tab_1.tabpage_1.dw_1.rowcount() > 0 then	
	...
	if k_rows > 0 then
		...
		if k_id_armo <> tab_1.tabpage_2.dw_2.getitemnumber(1, "id_armo") then
			k_rows = tab_1.tabpage_2.dw_2.retrieve(k_id_armo)  
		end if
	else
		k_rows = tab_1.tabpage_2.dw_2.retrieve(k_id_armo)  
	end if
...
type st_duplica from w_g_tab_3`st_duplica within w_armo_out
end type

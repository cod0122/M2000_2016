...
protected subroutine attiva_menu ();//
	if ki_st_open_w.flag_primo_giro = 'S' then
		m_main.m_finestra.m_gestione.m_fin_elimina.text = "Rimozione Completa della spedizione in Quarantena "
		m_main.m_finestra.m_gestione.m_fin_elimina.microhelp = "Rimuove tutte le informazioni circa la spedizione in quarantena (apertura, chiusura , ecc...) "
		m_main.m_finestra.m_gestione.m_fin_elimina.toolbaritemtext =  "Rimuove,"+ m_main.m_finestra.m_gestione.m_fin_elimina.text
	end if

...
//--- stampa schede barcode	
	private int ki_barcode_printed_idx
	private string ki_barcode_printed[]
...
private function integer u_print_barcode ()
protected subroutine stampa ()
private function boolean u_print_barcode_1 (string k_barcode, ref datastore kds_1)
	...
	case 6
		...
		if k_riga > 0 then
			if tab_1.tabpage_6.dw_6.getitemstatus(k_riga, 0, primary!) <> new! and &
				...
				kst_tab_memo.titolo = tab_1.tabpage_6.dw_6.getitemstring(k_riga, "titolo")
				k_record_1 = &
					"Sei sicuro di voler eliminare il MEMO " + string(kst_tab_memo.id_memo) + "~n~r" &
...
//--- Disabilita chiudendo o riattiva aprendo il Lotto
	m_main.m_strumenti.m_fin_gest_libero1.text = "Chiude/Annulla/Apre Lotto "
	m_main.m_strumenti.m_fin_gest_libero1.microhelp = m_main.m_strumenti.m_fin_gest_libero1.text
	...
	m_main.m_strumenti.m_fin_gest_libero1.toolbaritemtext = k_txt + ","+ m_main.m_strumenti.m_fin_gest_libero1.text
...
//--- Associa Dosimetro
	if not m_main.m_strumenti.m_fin_gest_libero2.toolbaritemvisible or ki_st_open_w.flag_primo_giro = 'S' then
		m_main.m_strumenti.m_fin_gest_libero2.text = "Accoppia Dosimetro "
		m_main.m_strumenti.m_fin_gest_libero2.microhelp = "Accoppia Dosimetro "
		if m_main.m_strumenti.m_fin_gest_libero2.enabled <>  ki_consenti_modalita_inserimento then
			m_main.m_strumenti.m_fin_gest_libero2.enabled = ki_consenti_modalita_inserimento
		end if
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemtext =  "Accoppia,"+ m_main.m_strumenti.m_fin_gest_libero2.text
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemvisible = true
		m_main.m_strumenti.m_fin_gest_libero2.visible = true
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemname = "accoppia_dosim16.png" //"UnionReturn!"
	end if

//DEPRECATO//--- Caricare nuove voci di costo al riferimento
//	if not m_main.m_strumenti.m_fin_gest_libero2.toolbaritemvisible or  ki_st_open_w.flag_primo_giro = 'S' then
//		m_main.m_strumenti.m_fin_gest_libero2.text = "Aggiungi q.tà alla Voce "
//		m_main.m_strumenti.m_fin_gest_libero2.microhelp = "Carica voci di costo aggiuntive al Lotto "
//		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemtext =  "Costi,"+ m_main.m_strumenti.m_fin_gest_libero2.text
//		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemvisible = true
//	end if

//--- Scaricare colli manualmente del riferimento
	if not m_main.m_strumenti.m_fin_gest_libero3.toolbaritemvisible or  ki_st_open_w.flag_primo_giro = 'S' then
		m_main.m_strumenti.m_fin_gest_libero3.text = "Scarico manuale colli "
		m_main.m_strumenti.m_fin_gest_libero3.microhelp = "Scaricare manualmente colli dalle righe Lotto "
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemtext =  "Scarica,"+ m_main.m_strumenti.m_fin_gest_libero3.text
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemvisible = true
		m_main.m_strumenti.m_fin_gest_libero3.visible = true
		m_main.m_strumenti.m_fin_gest_libero3.enabled = ki_consenti_modifica
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemname = "CheckDiff!"
	end if

//--- Rigenera Dosimetri
	if not m_main.m_strumenti.m_fin_gest_libero4.toolbaritemvisible or ki_st_open_w.flag_primo_giro = 'S' then
		m_main.m_strumenti.m_fin_gest_libero4.text = "Rigenera Dosimetri"
		m_main.m_strumenti.m_fin_gest_libero4.microhelp = "Rimuove e rigenera etichette dosimetri "
		m_main.m_strumenti.m_fin_gest_libero4.toolbaritemtext =  "Dosimetri,"+ m_main.m_strumenti.m_fin_gest_libero4.text
		m_main.m_strumenti.m_fin_gest_libero4.toolbaritemvisible = true
		m_main.m_strumenti.m_fin_gest_libero4.visible = true
		m_main.m_strumenti.m_fin_gest_libero4.enabled = ki_consenti_modifica or ki_consenti_modalita_inserimento
...
//--- Modifica numero/data LOTTO
	if not m_main.m_strumenti.m_fin_gest_libero7.libero1.toolbaritemvisible or ki_st_open_w.flag_primo_giro = 'S' then
		m_main.m_strumenti.m_fin_gest_libero7.libero1.text = "Cambia Data Lotto"
		m_main.m_strumenti.m_fin_gest_libero7.libero1.microhelp = "Cambia la data del Lotto"
		if (tab_1.tabpage_1.dw_1.rowcount() > 0 and ki_consenti_modalita_inserimento &
					and kist_tab_meca_orig.num_int > 0) &
				or ((tab_1.tabpage_1.dw_1.rowcount() = 0 or NOT ki_consenti_modalita_inserimento)) then
				//and NOT m_main.m_strumenti.m_fin_gest_libero7.enabled
							//and  m_main.m_strumenti.m_fin_gest_libero7.enabled) &
		...
		m_main.m_strumenti.m_fin_gest_libero7.libero1.toolbaritemtext =  "Data,"+ m_main.m_strumenti.m_fin_gest_libero7.libero1.text
...
//--- Genera DDT
	if not m_main.m_strumenti.m_fin_gest_libero10.toolbaritemvisible or  ki_st_open_w.flag_primo_giro = 'S' then
		...
		m_main.m_strumenti.m_fin_gest_libero10.microhelp = "Genera il DDT di spedizione o lo visualizza se esite già per questo Lotto"
		m_main.m_strumenti.m_fin_gest_libero10.enabled =  true
		m_main.m_strumenti.m_fin_gest_libero10.toolbaritemtext = "DDT,"+ m_main.m_strumenti.m_fin_gest_libero10.text
		m_main.m_strumenti.m_fin_gest_libero10.toolbaritemvisible = true
		m_main.m_strumenti.m_fin_gest_libero10.visible = true
		m_main.m_strumenti.m_fin_gest_libero10.toolbaritemname = "Deploy!"
	end if

	m_main.m_finestra.m_fin_stampa.text = "Stampa"
	m_main.m_finestra.m_fin_stampa.toolbaritemtext = "Stampa dati video"
...
//			m_main.m_strumenti.m_fin_gest_libero3.enabled =  false
			...
			m_main.m_finestra.m_gestione.m_fin_elimina.text = "Elimina Lotto"
			m_main.m_finestra.m_gestione.m_fin_elimina.microhelp = "Elimina definitivamente l'intero Lotto (Riferimento) "
			m_main.m_finestra.m_gestione.m_fin_elimina.toolbaritemtext = "Cancella,"+ m_main.m_finestra.m_gestione.m_fin_elimina.text
			m_main.m_finestra.m_gestione.m_fin_visualizza.enabled = this.cb_visualizza.enabled
			m_main.m_finestra.m_gestione.m_fin_visualizza.text = "Visualizza Lotto"
			m_main.m_finestra.m_gestione.m_fin_visualizza.microhelp = "Visualizza Lotto"
			m_main.m_finestra.m_gestione.m_fin_visualizza.toolbaritemtext = "Visualizza," + m_main.m_finestra.m_gestione.m_fin_visualizza.text 
			m_main.m_finestra.m_gestione.m_fin_modifica.enabled = this.cb_modifica.enabled
			m_main.m_finestra.m_gestione.m_fin_modifica.text = "Modifica Lotto"
...
//			m_main.m_strumenti.m_fin_gest_libero3.enabled =  true
			...
			m_main.m_finestra.m_gestione.m_fin_elimina.toolbaritemtext = "Cancella,"+ m_main.m_finestra.m_gestione.m_fin_inserimento.text
			m_main.m_finestra.m_gestione.m_fin_visualizza.enabled = this.cb_visualizza.enabled
			m_main.m_finestra.m_gestione.m_fin_visualizza.text = "Visualizza dettaglio Riga"
			m_main.m_finestra.m_gestione.m_fin_visualizza.microhelp = "Visualizza in dettaglio la Riga Lotto"
			m_main.m_finestra.m_gestione.m_fin_visualizza.toolbaritemtext = "Visualizza," + m_main.m_finestra.m_gestione.m_fin_visualizza.text 
			m_main.m_finestra.m_gestione.m_fin_modifica.enabled = this.cb_modifica.enabled
			m_main.m_finestra.m_gestione.m_fin_modifica.text = "Modifica Riga Lotto"
			m_main.m_finestra.m_gestione.m_fin_modifica.microhelp = "Modifica Riga Lotto (riga Riferimento)"
			m_main.m_finestra.m_gestione.m_fin_modifica.toolbaritemtext = "Modifica," + m_main.m_finestra.m_gestione.m_fin_modifica.text 
...
//--- Modifica 
			k_ok = messagebox("Operazione di: "+trim(m_main.m_strumenti.m_fin_gest_libero9.text), "L'operazione genera una Packing-List fittizia solo per uso interno, proseguire?", &
							question!, yesno!, 2) 
			if k_ok = 1 then
...
//	if kist_memo.st_tab_memo.id_memo  > 0 then
		...
		if k_risposta_load_memo_link = 3 then
			...
			if a_file_nr > 0 then
				...
				kuf1_memo_inout.crea_memo_meca(kst_memo, a_file[])
			end if
...
if kst_tab_f5547013.ehapid > " " then
	...
	if kst_tab_f5547013.ehapid <> kst_tab_f5547013_prec.ehapid then
		...
		if kguo_sqlca_db_e1.u_db_connetti(tab_1.tabpage_7.dw_7) then  // connette e fa transobject
...
if kst_e1_anteprima.apid > " " then
	...
	if kst_e1_anteprima.apid <> kst_e1_anteprima_prec.apid then
		...
		if kguo_sqlca_db_e1.u_db_connetti(tab_1.tabpage_8.dw_8) then  // connette e fa transobject
...
private function integer u_print_barcode ();//
int k_return
int k_row, k_rows, k_row_first, k_n_schede, k_row_list
datastore kds_barcode_list
st_stampe kst_stampe
st_tab_barcode kst_tab_barcode


if dw_print_barcode.getitemstring(1, "print_scheda") = "S"  &
			or dw_print_barcode.getitemstring(1, "print_scheda") = "T" then


	setpointer(kkg.pointer_attesa)
	
	kds_barcode_list = create datastore
	kds_barcode_list.dataobject = "ds_barcode_l_1"
	
	k_rows = tab_1.tabpage_3.dw_3.rowcount( )

//--- seleziona tutto?
	if dw_print_barcode.getitemstring(1, "print_scheda") = "T" then
		tab_1.tabpage_3.dw_3.selectrow(0,true)
		kds_barcode_list.settransobject(kguo_sqlca_db_magazzino)
		kds_barcode_list.retrieve(tab_1.tabpage_3.dw_3.getitemnumber(1, "id_meca"))
	else
	
//---ricava la prima riga da stampare	
		k_row = tab_1.tabpage_3.dw_3.getselectedrow(0) 
		if k_row = 0 then
			k_row = 1
			tab_1.tabpage_3.dw_3.selectrow(k_row,true)
		else
			k_row_first = k_row
		end if
		...
		do while k_row > 0 
			...
			kst_tab_barcode.barcode = trim(tab_1.tabpage_3.dw_3.getitemstring(k_row, "barcode"))
			kst_tab_barcode.barcode_lav = trim(tab_1.tabpage_3.dw_3.getitemstring(k_row, "barcode_lav"))

			if kst_tab_barcode.barcode_lav > " " then
				//--- stampa il barcode padre solo se appartiene allo stesso lotto
				if tab_1.tabpage_3.dw_3.getitemnumber(k_row, "id_meca") <> tab_1.tabpage_3.dw_3.getitemnumber(k_row, "id_meca_padre") then
				else
					k_row_list ++
					kds_barcode_list.insertrow(0)
					kds_barcode_list.setitem(k_row_list, "barcode", kst_tab_barcode.barcode_lav)
				end if
			end if
			...
			tab_1.tabpage_3.dw_3.selectrow(k_row,false)
			k_row = tab_1.tabpage_3.dw_3.getselectedrow(0) 
			
		loop
	end if

//--- stampa le righe caricate nel ds
	if kds_barcode_list.rowcount( ) > 0 then
		k_n_schede = u_print_barcode_0(kds_barcode_list)
	end if

	tab_1.tabpage_3.dw_3.selectrow(0,false)
	if k_row_first > 0 then
		tab_1.tabpage_3.dw_3.selectrow(k_row_first,true)
	end if

	setpointer(kkg.pointer_default)

	messagebox("Stampa Barcode Terminata", "Sono stati stampate " + string(k_n_schede) + " schede.") 
...
int k_ctr
	...
	// verifica che non sia presente nelle precedenti schede già stampate
	k_printed = false
	for k_ctr = 1 to ki_barcode_printed_idx
		if ki_barcode_printed[k_ctr] = k_barcode then
			k_printed = true
			exit
		end if
	next

	if not k_printed then

		kds_1.retrieve(k_barcode)

		ki_barcode_printed_idx ++
		ki_barcode_printed[ki_barcode_printed_idx] = k_barcode

	end if	
	
return not k_printed

end function

private function integer u_print_barcode_0 (ref datastore kds_barcode_list);//
long k_job
int k_row, k_rows, k_n_schede
datastore kds_1
...
//--- stampa le righe caricate nel ds
	kds_1 = create datastore
	kds_1.dataobject = "d_barcode"
	kds_1.settransobject(kguo_sqlca_db_magazzino)
	k_job = PrintOpen( )

	k_rows = kds_barcode_list.rowcount( )
	for k_row = 1 to k_rows
		if u_print_barcode_1(kds_barcode_list.getitemstring(k_row, "barcode"), kds_1) then
			PrintDataWindow(k_job, kds_1)
			k_n_schede++
		end if
	next
...
//	if ki_consenti_modifica then
	...
	//--- prima rigenera i flag dove vanno posti i dosimetri
			...
			if kst_tab_barcode.st_tab_g_0.contati > 0 then
	//--- rigenera le etichette dosimetri (meca_dosim)
			...
			if k_nbcode > 0 then
				messagebox("Rigenerazione conclusa", "Sono state generate " + string(k_nbcode) + " etichette dosimetri! " &
			...
			tab_1.tabpage_3.dw_3.reset( )  // resetta elenco barcode x rileggere
			tab_1.post selecttab(3)  // si posiziona sui barcode
			
		end if	
	else
		kst_esito.esito = kkg_esito.no_esecuzione
		kst_esito.sqlerrtext = "Rigenerazione etichette dosimetri non eseguito. Manca indicazione del Lotto (id)!"
		kguo_exception.inizializza( )
...
//--- chiama la window 
	...
	if isvalid(kuf1_meca_autorizza) then destroy kuf1_meca_autorizza
...
type dw_print_0 from w_g_tab_3`dw_print_0 within w_meca_1
end type
...
type st_duplica from w_g_tab_3`st_duplica within w_meca_1
end type
...
boolean enabled = true
boolean titlebar = true
string title = "Stampa Barcode"
string dataobject = "d_meca_barcode_print"
boolean controlmenu = true
boolean hscrollbar = false
boolean vscrollbar = false
boolean hsplitscroll = false

...
//
	...
	elseif ki_ultimo_guida_flag_convalidati = 1 then
		...
		k_convalida_short = "Riconv."
	end if
	if not m_main.m_strumenti.m_fin_gest_libero3.enabled <> k_convalida &
					or m_main.m_strumenti.m_fin_gest_libero3.text <> k_convalida_text &
					or not m_main.m_strumenti.m_fin_gest_libero3.visible then
		m_main.m_strumenti.m_fin_gest_libero3.text = k_convalida_text
		m_main.m_strumenti.m_fin_gest_libero3.microhelp = k_convalida_help
		m_main.m_strumenti.m_fin_gest_libero3.enabled = k_convalida
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemVisible = true
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemText = k_convalida_short + "," + k_convalida_text
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemName = "spunta32.png"
//		ki_menu.m_strumenti.m_fin_gest_libero3.toolbaritembarindex=2
	...
	if not m_main.m_strumenti.m_fin_gest_libero4.enabled then
		m_main.m_strumenti.m_fin_gest_libero4.text = "Cambia data estrazione lotti "
		m_main.m_strumenti.m_fin_gest_libero4.microhelp = "Cambia data estrazione lotti "
...
//	
	if ki_ultimo_guida_flag_convalidati = 0 then
		...
		m_main.m_strumenti.m_fin_gest_libero8.enabled = false
	end if
	if not m_main.m_strumenti.m_fin_gest_libero8.visible  then
		m_main.m_strumenti.m_fin_gest_libero8.text = "Deseleziona tutto "
		m_main.m_strumenti.m_fin_gest_libero8.microhelp = "Toglie il segno di spunta a tutti i lotti in elenco   "
		m_main.m_strumenti.m_fin_gest_libero8.toolbaritemtext = "Deselez.,"+  m_main.m_strumenti.m_fin_gest_libero8.text
		m_main.m_strumenti.m_fin_gest_libero8.toolbaritemname = "custom080!"
...
//	
	...
	if not m_main.m_strumenti.m_fin_gest_libero9.visible  then
		m_main.m_strumenti.m_fin_gest_libero9.text = "Seleziona tutto "
		m_main.m_strumenti.m_fin_gest_libero9.microhelp = "Segno di spunta su tutti i lotti in elenco   "
		m_main.m_strumenti.m_fin_gest_libero9.toolbaritemtext = "Selez.,"+ m_main.m_strumenti.m_fin_gest_libero9.text
		m_main.m_strumenti.m_fin_gest_libero9.toolbaritemname = "custom038!"
...
//--- Elabora Argomenti programma chiamante
	...
	if trim(ki_st_open_w.key3) > " " then									// DA QUALE DATA SCADENZA?
		if isdate(trim(ki_st_open_w.key3)) then
			...
			ki_data_int_da = relativedate(kguo_g.get_dataoggi( ), -365)
		end if
	else
		ki_data_int_da = relativedate(kguo_g.get_dataoggi( ), -365)
	end if

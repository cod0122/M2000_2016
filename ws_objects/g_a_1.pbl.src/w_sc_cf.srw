...
//
	if m_main.m_strumenti.m_fin_gest_libero1.enabled <> cb_modifica.enabled then
		
		m_main.m_strumenti.m_fin_gest_libero1.text = "Attiva/Disattiva Capitolati alla data"
		...
		m_main.m_strumenti.m_fin_gest_libero1.enabled = cb_modifica.enabled
		m_main.m_strumenti.m_fin_gest_libero1.toolbaritemVisible = true
		m_main.m_strumenti.m_fin_gest_libero1.toolbaritemText = "Attiva,"+m_main.m_strumenti.m_fin_gest_libero1.text
...
//		ki_menu.m_strumenti.m_fin_gest_libero1.toolbaritembarindex=2
	...
	if not m_main.m_strumenti.m_fin_gest_libero2.visible then
		...
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemName = "ShowWatch1!"
...
type st_duplica from w_g_tab0`st_duplica within w_sc_cf
end type

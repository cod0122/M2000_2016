...
choose case k_tipo_oggetto
	case kist_treeview_oggetto.barcode_no_st_dett &
		...
		k_return = kuf1_barcode.u_tree_riempi_listview_x_rifer_da_stamp( ki_this, k_tipo_oggetto )
	case else
...
//--- scrive l'errore su LOG
	kst_esito.nome_oggetto = this.classname()
	kst_esito.sqlsyntax = trim(kSQLCA.sqlerrtext)
	kst_esito.sqlerrtext = trim(kSQLCA.SQLErrText)
	kst_esito.sqldbcode = ksqlca.sqlcode
	//kst_esito.sqlca = ksqlca
...
//--- LISTVIEW ------------------------------------------------------------------------------------------------	
	...
	//--- Gestione "ramo" BARCODE
				case kist_treeview_oggetto.barcode_no_st_dett, &
					  ...
					  kist_treeview_oggetto.barcode_sosp_dett, &
					  kist_treeview_oggetto.barcode_tutti_dett
					u_riempi_listview_barcode_gener(kist_treeview_oggetto.oggetto)
				case kist_treeview_oggetto.barcode_dett, &
...
choose case k_tipo_oggetto
	...
	case kist_treeview_oggetto.certif_st_giorno
		...
		if classname(klvi_listviewitem.data) = "st_treeview_data" then
			kst_treeview_data = klvi_listviewitem.data
			kst_treeview_data_any = kst_treeview_data.struttura
...
try
	...
	if ast_tab_barcode.id_meca > 0 then
		...
		kst_tab_armo.num_int = ast_tab_barcode.num_int
		kst_tab_armo.data_int = ast_tab_barcode.data_int

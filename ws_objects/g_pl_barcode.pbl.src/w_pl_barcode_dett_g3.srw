...
private subroutine u_aggiungi_figli_al_dw_groupage (long a_riga)
...
//--- controlla se utente autorizzato a cambiare lo stato in attenzione del lotto
	...
	k_rc = kguf_data_base.dw_ripri_righe( "v.1", "dwguida", dw_guida, k_datetime_bck)
	if k_rc > 0 then 
	else
...
st_esito kst_esito
	...
	try 
		...
		if dw_barcode.getitemnumber(k_riga2, "sl_pt_g3_lav_ngiri") > 0 then
		else
		...
		dw_groupage.setitem(k_riga1, "g3npass", dw_barcode.getitemnumber(k_riga2, "g3npass"))
		dw_groupage.setitem(k_riga1, "g3ngiri", dw_barcode.getitemnumber(k_riga2, "ngiri")) 
		dw_groupage.setitem(k_riga1, "g3ciclo", dw_guida.getitemnumber(1, "g3ciclo"))
		dw_groupage.setitem(k_riga1, "ciclo_min", dw_barcode.getitemnumber(k_riga2, "ciclo_min")) 
		dw_groupage.setitem(k_riga1, "ciclo_max", dw_barcode.getitemnumber(k_riga2, "ciclo_max"))
		dw_groupage.setitem(k_riga1, "id_sl_pt_g3_lav", dw_barcode.getitemnumber(k_riga2, "id_sl_pt_g3_lav"))
...
//---
		...
		dw_lista_0.setitem(k_riga1, "barcode_barcode", dw_barcode.getitemstring(k_riga2, "barcode_barcode"))
		
		dw_lista_0.setitem(k_riga1, "g3npass", dw_barcode.getitemnumber(k_riga2, "g3npass"))
		dw_lista_0.setitem(k_riga1, "g3ngiri", dw_barcode.getitemnumber(k_riga2, "ngiri"))
		
		if dw_guida.getitemnumber(1, "g3ciclo") > 0 then
			dw_lista_0.setitem(k_riga1, "g3ciclo", dw_guida.getitemnumber(1, "g3ciclo"))
		else
			dw_lista_0.setitem(k_riga1, "g3ciclo", ki_g3ciclo_alt)
		end if
		dw_lista_0.setitem(k_riga1, "id_sl_pt_g3_lav", dw_barcode.getitemnumber(k_riga2, "id_sl_pt_g3_lav"))
		dw_lista_0.setitem(k_riga1, "ciclo_min", dw_barcode.getitemnumber(k_riga2, "ciclo_min"))
		dw_lista_0.setitem(k_riga1, "ciclo_max", dw_barcode.getitemnumber(k_riga2, "ciclo_max"))
...
//---
		...
		dw_groupage.setitem(k_riga1, "barcode_barcode",  dw_lista_0.getitemstring(k_riga2, "barcode_barcode"))
		
		dw_groupage.setitem(k_riga1, "g3npass", dw_lista_0.getitemnumber(k_riga2, "g3npass"))
		dw_groupage.setitem(k_riga1, "g3ngiri", dw_lista_0.getitemnumber(k_riga2, "g3ngiri"))
		dw_groupage.setitem(k_riga1, "g3ciclo", dw_lista_0.getitemnumber(k_riga2, "g3ciclo"))
		dw_groupage.setitem(k_riga1, "id_sl_pt_g3_lav", dw_lista_0.getitemnumber(k_riga2, "id_sl_pt_g3_lav"))
		dw_groupage.setitem(k_riga1, "ciclo_min", dw_lista_0.getitemnumber(k_riga2, "ciclo_min"))
		dw_groupage.setitem(k_riga1, "ciclo_max", dw_lista_0.getitemnumber(k_riga2, "ciclo_max"))
...
try
	...
	kst_tab_barcode.barcode = trim(dw_lista_0.getitemstring(a_riga, "barcode_barcode"))
...
//--- se il barcode non c'e' ancora tra i figli allora lo aggiungo
			if k_riga_find < 1  then
				...
				dw_groupage.setitem(k_rows_grp, "g3npass", dw_lista_0.getitemstring(a_riga, "g3npass"))
				dw_groupage.setitem(k_rows_grp, "g3ngiri", dw_lista_0.getitemstring(a_riga, "ngiri"))
				dw_groupage.setitem(k_rows_grp, "g3ciclo", dw_lista_0.getitemstring(a_riga, "g3ciclo"))
...
//--- se anche solo un barcode è già stato trasferito al PILOTA allora NON si può APRIRE
		kst_tab_pl_barcode.codice = dw_dett_0.getitemnumber(dw_dett_0.getrow(), "codice")
		if kiuf_pl_barcode.if_pl_trasferito_al_pilota(kst_tab_pl_barcode) then
			...
			k_nrc = messagebox("Riapre Programmazione - Elaborazione CRITICA ", &
					  ...
					  + kkg.acapo + "I barcode sembrano ancora disponibili ma il PILOTA potrebbe avere caricato il Piano senza informare M2000. " &
...
//-------------------------------------------------------			
		...
		try 
			...
			kst_tab_pl_barcode.codice = dw_dett_0.getitemnumber(dw_dett_0.getrow(), "codice")
			kiuf_pl_barcode.get_path_file_pilota(kst_tab_pl_barcode)
			kiuf_pl_barcode.cancella_file_pilota(kst_tab_pl_barcode)
...
//--- Cerco il barcode PADRE 
			...
			if k_riga_find_padre > 0  then
				...
				dw_groupage.setitem(k_riga_find, "g3ngiri", dw_lista_0.getitemnumber(k_riga_find_padre, "ngiri"))
...
if ki_st_open_w.flag_modalita = kkg_flag_modalita.inserimento &
	...
	//--- popolo il datasore (dw non visuale) per appoggio elenco
			...
			k_riga=0
			kdsi_elenco_output.dataobject = "d_barcode_g3_l_rid"  //dw_lista_0.dataobject
			for k_riga_lista = 1 to dw_lista_0.rowcount()

// verifica se lavoraz compatibile da elenco barcode qui in Programmazione
				kds1_sl_pt_g3_lav_if_padre_figlio_ok.get_datilav_figlio_if_ok(kst_tab_barcode.barcode, &
																			dw_lista_0.getitemnumber(k_riga_lista, "id_sl_pt_g3_lav"), &
																			dw_guida.getitemnumber(1, "g3ciclo"))
				
				if kds1_sl_pt_g3_lav_if_padre_figlio_ok.rowcount( ) > 0 then
					if dw_groupage.find("barcode_barcode = " + "'" + dw_lista_0.object.barcode_barcode[k_riga_lista] + "'", 1, dw_lista_0.rowcount()) = 0 then
						...
						kdsi_elenco_output.setitem( k_riga, "g3npass", dw_lista_0.object.g3npass[k_riga_lista])
						kdsi_elenco_output.setitem( k_riga, "g3ciclo", dw_lista_0.object.g3ciclo[k_riga_lista])
						kdsi_elenco_output.setitem( k_riga, "g3ngiri", dw_lista_0.object.g3ngiri[k_riga_lista])
						kdsi_elenco_output.setitem( k_riga, "ciclo_min", dw_lista_0.object.ciclo_min[k_riga_lista])
						kdsi_elenco_output.setitem( k_riga, "ciclo_max", dw_lista_0.object.ciclo_max[k_riga_lista])
...
// verifica se lavoraz compatibile da elenco barcode qui dal dettaglio elenco barcode
				kds1_sl_pt_g3_lav_if_padre_figlio_ok.get_datilav_figlio_if_ok(kst_tab_barcode.barcode, &
																			dw_barcode.getitemnumber(k_riga_lista, "id_sl_pt_g3_lav"), &
																			dw_guida.getitemnumber(1, "g3ciclo"))
				...
				if kds1_sl_pt_g3_lav_if_padre_figlio_ok.rowcount( ) > 0 then
					if dw_groupage.find("barcode_barcode = " + "'" + dw_barcode.object.barcode_barcode[k_riga_lista] + "'", 1, dw_barcode.rowcount()) = 0 then
							...
							kdsi_elenco_output.setitem( k_riga, "g3npass", dw_barcode.object.g3npass[k_riga_lista])
							kdsi_elenco_output.setitem( k_riga, "g3ciclo", dw_barcode.object.g3ciclo[k_riga_lista])
							kdsi_elenco_output.setitem( k_riga, "g3ngiri", dw_barcode.object.g3ngiri[k_riga_lista])
							kdsi_elenco_output.setitem( k_riga, "ciclo_min", dw_barcode.object.ciclo_min[k_riga_lista])
							kdsi_elenco_output.setitem( k_riga, "ciclo_max", dw_barcode.object.ciclo_max[k_riga_lista])
...
//--- leggo righe 
	...
	dw_meca.title = "Elenco Riferimenti non Pianificati"
	...
	dw_meca.retrieve(ki_data_ini, k_npass, k_ciclo, k_ciclo_min, k_ciclo_max)   //--- leggo su DB
...
k_riga = 1 //dw_dett_0.rowcount()
	...
	dw_dett_0.setitem(k_riga, "id_programma", kst_tab_pl_barcode.id_programma)
...
//	kguo_sqlca_db_pilota.db_connetti()
	...
	kdsi_elenco_output.dataobject = "d_pilota_g3_queue_table_h" 
...
//--- Se dalla w di elenco doppio-click		
			choose case kst_open_w.key2
				...
				case "d_pilota_g3_queue_table_h" 
...
event dw_guida::getfocus;call super::getfocus;//-- NPASS impostabile solo se non c'è nulla nei Pianificati
if dw_lista_0.rowcount( ) > 0 then
...
event dw_guida::buttonclicked;call super::buttonclicked;//

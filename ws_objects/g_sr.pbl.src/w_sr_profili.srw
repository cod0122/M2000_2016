...
kuf_utility kuf1_utility
	...
	choose case tab_1.selectedtab 
		...
		case 2 
			m_main.m_finestra.m_gestione.m_fin_inserimento.text = "Aggiunge Funzione"
			m_main.m_finestra.m_gestione.m_fin_elimina.text = "Toglie Funzione"
...
//
	...
	if not m_main.m_strumenti.m_fin_gest_libero1.visible then
		m_main.m_strumenti.m_fin_gest_libero1.text = "Importa tutte le Funzioni"

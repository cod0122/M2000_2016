	...
	case 1 
		...
		if k_riga > 0 then
			if tab_1.tabpage_1.dw_1.getitemstatus(k_riga, 0, primary!) <> new! and &
				...
				//+ "~n~r" + &
				k_record_1 = &
					"Sei sicuro di voler rimuovere la " + trim(tab_1.tabpage_1.text) & 
	...
	case 2 
		...
		if k_riga > 0 then
			if tab_1.tabpage_2.dw_2.getitemstatus(k_riga, 0, primary!) <> new! and &
				...
				k_record_1 = &
					"Sei sicuro di voler rimuovere l'associazione con il Profilo" + "~n~r" + &
...
//
	if m_main.m_strumenti.m_fin_gest_libero1.visible <> cb_inserisci.enabled then
		...
		m_main.m_strumenti.m_fin_gest_libero1.enabled = cb_inserisci.enabled
		m_main.m_strumenti.m_fin_gest_libero1.toolbaritemtext = "Importa,"+&
	...
	//	ki_menu.m_strumenti.m_fin_gest_libero1.toolbaritembarindex = 2
		...
		m_main.m_strumenti.m_fin_gest_libero1.toolbaritemname = "CheckIn!" //ki_path_risorse + "\barcode.bmp"
	end if
...
if tab_1.tabpage_1.dw_1.rowcount() = 0 then
	...
	u_mostra_operazioni_disp() // mostra le operazioni disponibili della funzione letta
...
//--- rilegge la dw dei programmi
		if tab_1.tabpage_3.dw_3.rowcount() = 0 then
			tab_1.tabpage_3.dw_3.retrieve()  
		end if

		k_id_programma = trim(tab_1.tabpage_1.dw_1.getitemstring(k_riga, "id_programma"))

//		if tab_1.tabpage_1.dw_1.getitemdate(k_riga, "data_1") > kkg.data_zero then				
//		else
//			k_dataoggi = 
			tab_1.tabpage_1.dw_1.setitem(k_riga, "data_1", kguo_g.get_dataoggi( ))
//		end if

//		if trim(tab_1.tabpage_1.dw_1.getitemstring(k_riga, "descrizione")) > " " then				
//		else
		k_riga_dw3 = tab_1.tabpage_3.dw_3.Find( "id = '" + k_id_programma + "' ", &
...
//		end if
		...
		tab_1.tabpage_1.dw_1.setitem ( k_riga, "nome", upper(tab_1.tabpage_1.dw_1.getitemstring ( k_riga, "id_programma")))

//--- imposta le funzioni/operazioni 
//		if trim(tab_1.tabpage_1.dw_1.getitemstring(k_riga, "funzioni")) > " " &
//				and trim(tab_1.tabpage_1.dw_1.getitemstring(k_riga, "funzioni")) <> "X" &
//			then				
//		else
...
type dw_print_0 from w_g_tab_3`dw_print_0 within w_sr_funzioni
end type

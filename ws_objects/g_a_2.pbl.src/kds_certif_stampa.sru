...
global type kds_certif_stampa from uo_datastore_0
string dataobject = "d_att_stampa_ed2_01_2024"
end type
global kds_certif_stampa kds_certif_stampa

type variables
//
private string ki_att_stampa_default = "d_certif_stampa_2008_6" // nel caso non sia trovato il nome dello stampato (soprattutto per i vecchi documenti)
private string ki_att_stampa_gold = "d_att_stampa_ed2_01_2024" //"d_att_stampa_ed7_07_2018" //"d_att_stampa_ed6_05_2016" //"d_att_stampa_ed5_09_2015" //"d_att_stampa_ed4_01_2013" // "d_att_stampa_ed3_03_2012" //"d_att_stampa_ed9_05_2011" //"d_att_stampa_ed8_04_2010" //"d_att_stampa_ed7_08_2009"
private string ki_att_stampa_silver = "d_att_stampa_ed2_01_2024" //"d_att_stampa_ed4b07_2018" //"d_att_stampa_ed3b05_2016" //"d_att_stampa_ed2b09_2015" //"d_att_stampa_ed1b01_2013" //"d_att_stampa_ed0b03_2012" //"d_att_stampa_ed9b05_2011" //"d_att_stampa_ed8b04_2010" //"d_att_stampa_ed7_08_2009"
...
//			kst_tab_certif.id_meca = kuf1_artr.get_id_meca_da_num_certif(kst_tab_artr)
			...
			if kst_tab_armo.id_armo > 0 then
				if kuf1_armo.get_id_meca_da_id_armo(kst_tab_armo) > 0 then
...
public subroutine u_set_test (boolean a_flag_stampa_di_test);//
//--- imposta il flag di TEST sul modulo utile per fare/non fare la stampa del testo 'TEST' 
//

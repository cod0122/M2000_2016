...
protected subroutine u_proteggi_sproteggi ()
end prototypes
...
//=== Aggiunge una riga al data windows
	...
	if kdw_x.describe("DataWindow.Processing") = '1' then
		for k_ind = 1 to 10 
			kdw_x.insertrow(0)
		next
	end if
...
ki_tabtext_sizemax_onleft = 550
end event

type dw_print_0 from w_g_tab_3`dw_print_0 within w_ausiliari
end type
...
type st_duplica from w_g_tab_3`st_duplica within w_ausiliari
end type

...
//
	if m_main.m_strumenti.m_fin_gest_libero1.enabled <> ki_stampa_attestato then
		m_main.m_strumenti.m_fin_gest_libero1.text = "Stampa Attestato"
		m_main.m_strumenti.m_fin_gest_libero1.microhelp = "Stampa Attestato di Trattamento"
		m_main.m_strumenti.m_fin_gest_libero1.visible = true
		m_main.m_strumenti.m_fin_gest_libero1.enabled = ki_stampa_attestato
		m_main.m_strumenti.m_fin_gest_libero1.toolbaritemVisible = true
		m_main.m_strumenti.m_fin_gest_libero1.toolbaritemText = "Stampa,"+m_main.m_strumenti.m_fin_gest_libero1.text
...
//--- get dati attestato calcolati dal programma
					 kuf1_certif.crea_certif_set_st_tab_certif(kst_tab_certif)
				end if
			end if
...
type st_duplica from w_g_tab_3`st_duplica within w_certif
end type

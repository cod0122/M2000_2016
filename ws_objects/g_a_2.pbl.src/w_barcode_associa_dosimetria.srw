...
type dw_print_0 from w_g_tab0`dw_print_0 within w_barcode_associa_dosimetria
end type
...
type st_duplica from w_g_tab0`st_duplica within w_barcode_associa_dosimetria
end type

...
//
	m_main.m_finestra.m_fin_stampa.text = "Stampa Anagrafiche"
	m_main.m_finestra.m_fin_stampa.toolbaritemText = "Stampa,Stampa Anagrafiche"

	if m_main.m_strumenti.m_fin_gest_libero1.enabled <> cb_contratti.enabled or m_main.m_strumenti.m_fin_gest_libero1.toolbaritemVisible then 
		m_main.m_strumenti.m_fin_gest_libero1.text = "Elenco Capitolati"
		m_main.m_strumenti.m_fin_gest_libero1.microhelp = "Capitolati,Elenco Capitolati per l'anagrafica selezionata"
		m_main.m_strumenti.m_fin_gest_libero1.enabled = cb_contratti.enabled
	...
	if m_main.m_strumenti.m_fin_gest_libero2.enabled <> cb_contratti.enabled or not m_main.m_strumenti.m_fin_gest_libero2.toolbaritemVisible then
		m_main.m_strumenti.m_fin_gest_libero2.text = "Elenco Conferme Ordini"
		m_main.m_strumenti.m_fin_gest_libero2.microhelp = "CO,Elenco Conferme Ordini per l'anagrafica selezionata"
		m_main.m_strumenti.m_fin_gest_libero2.enabled = cb_contratti.enabled
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemVisible = true
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemText =  "Contr.,Conferme Ordini per l'anagrafica selezionata"
	...
	if m_main.m_strumenti.m_fin_gest_libero3.enabled <> cb_listino.enabled or not m_main.m_strumenti.m_fin_gest_libero3.toolbaritemVisible then
		m_main.m_strumenti.m_fin_gest_libero3.text = cb_listino.text
		m_main.m_strumenti.m_fin_gest_libero3.microhelp = &
		"Listini,Elenco Listini dell'anagrafica selezionata"
		m_main.m_strumenti.m_fin_gest_libero3.enabled = cb_listino.enabled
...
//	end if
//
	if m_main.m_strumenti.m_fin_gest_libero5.enabled <> st_elenco.enabled or not m_main.m_strumenti.m_fin_gest_libero5.visible then
		m_main.m_strumenti.m_fin_gest_libero5.text = st_elenco.text
		m_main.m_strumenti.m_fin_gest_libero5.microhelp = "Compatta,Comprime elenco, riduce le colonne "
		m_main.m_strumenti.m_fin_gest_libero5.enabled = st_elenco.enabled
		m_main.m_strumenti.m_fin_gest_libero5.toolbaritemVisible = true
		m_main.m_strumenti.m_fin_gest_libero5.toolbaritemText = "Compatta,Comprime/Estende elenco "
		m_main.m_strumenti.m_fin_gest_libero5.toolbaritemName = "PlaceColumn5!"
...
//	parent.setredraw(false)
	...
	dw_lista_0.Modify("cell.Visible=" + k_flag)
//	dw_lista_0.Modify("email1.Visible=" + k_flag)
...
//		dw_lista_0.Modify("banca.Visible=" + k_flag)
	...
	dw_lista_0.Modify("cell_t.Visible=" + k_flag)
	//dw_lista_0.Modify("email1_t.Visible=" + k_flag)
...
long k_return=0	
	...
	if trim(ki_st_tab_clienti.tipo) > " " then 
	else
		ki_st_tab_clienti.tipo = "*"
	end if

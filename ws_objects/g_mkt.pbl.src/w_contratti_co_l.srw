...
//
	...
	if not m_main.m_strumenti.m_fin_gest_libero7.visible then
		m_main.m_strumenti.m_fin_gest_libero7.libero1.text = "Mostra Contratti Commerciali in Vigore "
		...
		m_main.m_strumenti.m_fin_gest_libero7.libero2.text = "Mostra Contratti Commerciali Annullati"
		...
		m_main.m_strumenti.m_fin_gest_libero7.libero3.text = "Mostra Tutti i Contratti Commerciali"
...
type dw_print_0 from w_g_tab0`dw_print_0 within w_contratti_co_l
end type

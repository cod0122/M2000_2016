...
protected function integer u_dw_4_retrieve () throws uo_exception
...
//--- legge tiutte le DWC			
			...
			if tab_1.tabpage_1.dw_1.rowcount() > 0 then
				...
				if tab_1.tabpage_3.dw_3.rowcount() > 0 then
					kist_tab_contratti_doc.unita_misura[1] = tab_1.tabpage_3.dw_3.getitemstring(1, "unita_misura") 
					kist_tab_contratti_doc.mis_x[1] = tab_1.tabpage_3.dw_3.getitemnumber(1, "mis_x_1")
					kist_tab_contratti_doc.mis_y[1] = tab_1.tabpage_3.dw_3.getitemnumber(1, "mis_y_1")
					kist_tab_contratti_doc.mis_z[1] = tab_1.tabpage_3.dw_3.getitemnumber(1, "mis_z_1")
...
try
	...
	if messagebox("Duplica Quotazione", "Genera il nuovo Contratto copiando i dati da questo~n~r" &
	...
	if k_return < 0 then
		...
		if k_return = 0 then
		   if trim(ki_st_open_w.flag_modalita) = kkg_flag_modalita.inserimento or trim(ki_st_open_w.flag_modalita) = kkg_flag_modalita.modifica then
				inserisci_2() //tab_1.tabpage_2.dw_2.insertrow(0)
			end if
		end if
	end if
...
if tab_1.tabpage_3.dw_3.rowcount( ) > 0 then
	kst_tab_contratti_doc.unita_misura[1] = tab_1.tabpage_3.dw_3.getitemstring(1, "unita_misura") 
	kst_tab_contratti_doc.mis_x[1] = tab_1.tabpage_3.dw_3.getitemnumber(1, "mis_x_1")
	kst_tab_contratti_doc.mis_y[1] = tab_1.tabpage_3.dw_3.getitemnumber(1, "mis_y_1")
	kst_tab_contratti_doc.mis_z[1] = tab_1.tabpage_3.dw_3.getitemnumber(1, "mis_z_1")
	kst_tab_contratti_doc.peso_max_kg[1] = tab_1.tabpage_3.dw_3.getitemnumber(1, "peso_max_kg")
	kst_tab_contratti_doc.dose_min[1] = tab_1.tabpage_3.dw_3.getitemnumber(1, "dose_min")
	kst_tab_contratti_doc.dose_max[1] = tab_1.tabpage_3.dw_3.getitemnumber(1, "dose_max")
	kst_tab_contratti_doc.density_x[1] = tab_1.tabpage_3.dw_3.getitemstring(1, "density_x")
	kst_tab_contratti_doc.e1litm[1] = tab_1.tabpage_3.dw_3.getitemstring(1, "e1litm")
	kst_tab_contratti_doc.prezzo[1] = tab_1.tabpage_3.dw_3.getitemnumber(1, "prezzo_1")
	kst_tab_contratti_doc.code_our[1] = tab_1.tabpage_3.dw_3.getitemstring( 1, "code_our_1")
	kst_tab_contratti_doc.qaa[1] = tab_1.tabpage_3.dw_3.getitemstring( 1, "qaa_1")

	kst_tab_contratti_doc.unita_misura[2] = tab_1.tabpage_3.dw_3.getitemstring(1, "unita_misura_2") 
	kst_tab_contratti_doc.mis_x[2] = tab_1.tabpage_3.dw_3.getitemnumber(1, "mis_x_2")
	kst_tab_contratti_doc.mis_y[2] = tab_1.tabpage_3.dw_3.getitemnumber(1, "mis_y_2")
	kst_tab_contratti_doc.mis_z[2] = tab_1.tabpage_3.dw_3.getitemnumber(1, "mis_z_2")
	kst_tab_contratti_doc.peso_max_kg[2] = tab_1.tabpage_3.dw_3.getitemnumber(1, "peso_max_kg_2")
	kst_tab_contratti_doc.dose_min[2] = tab_1.tabpage_3.dw_3.getitemnumber(1, "dose_min_2")
	kst_tab_contratti_doc.dose_max[2] = tab_1.tabpage_3.dw_3.getitemnumber(1, "dose_max_2")
	kst_tab_contratti_doc.density_x[2] = tab_1.tabpage_3.dw_3.getitemstring(1, "density_x_2")
	kst_tab_contratti_doc.e1litm[2] = tab_1.tabpage_3.dw_3.getitemstring(1, "e1litm_2")
	kst_tab_contratti_doc.prezzo[2] = tab_1.tabpage_3.dw_3.getitemnumber(1, "prezzo_2")
	kst_tab_contratti_doc.code_our[2] = tab_1.tabpage_3.dw_3.getitemstring( 1, "code_our_2")
	kst_tab_contratti_doc.qaa[2] = tab_1.tabpage_3.dw_3.getitemstring( 1, "qaa_2")

	kst_tab_contratti_doc.unita_misura[3] = tab_1.tabpage_3.dw_3.getitemstring(1, "unita_misura_3") 
	kst_tab_contratti_doc.mis_x[3] = tab_1.tabpage_3.dw_3.getitemnumber(1, "mis_x_3")
	kst_tab_contratti_doc.mis_y[3] = tab_1.tabpage_3.dw_3.getitemnumber(1, "mis_y_3")
	kst_tab_contratti_doc.mis_z[3] = tab_1.tabpage_3.dw_3.getitemnumber(1, "mis_z_3")
	kst_tab_contratti_doc.peso_max_kg[3] = tab_1.tabpage_3.dw_3.getitemnumber(1, "peso_max_kg_3")
	kst_tab_contratti_doc.dose_min[3] = tab_1.tabpage_3.dw_3.getitemnumber(1, "dose_min_3")
	kst_tab_contratti_doc.dose_max[3] = tab_1.tabpage_3.dw_3.getitemnumber(1, "dose_max_3")
	kst_tab_contratti_doc.density_x[3] = tab_1.tabpage_3.dw_3.getitemstring(1, "density_x_3")
	kst_tab_contratti_doc.e1litm[3] = tab_1.tabpage_3.dw_3.getitemstring(1, "e1litm_3")
	kst_tab_contratti_doc.prezzo[3] = tab_1.tabpage_3.dw_3.getitemnumber(1, "prezzo_3")
	kst_tab_contratti_doc.code_our[3] = tab_1.tabpage_3.dw_3.getitemstring( 1, "code_our_3")
	kst_tab_contratti_doc.qaa[3] = tab_1.tabpage_3.dw_3.getitemstring( 1, "qaa_3")
	...
	kst_tab_contratti_doc.treat_validate = tab_1.tabpage_3.dw_3.getitemstring( 1, "treat_validate")
...
//--- Se NO inserimento.... 
	...
	if k_return < 0 then
		...
		if k_return = 0 then
		   if trim(ki_st_open_w.flag_modalita) = kkg_flag_modalita.inserimento or trim(ki_st_open_w.flag_modalita) = kkg_flag_modalita.modifica then
				inserisci_3()   //tab_1.tabpage_3.dw_3.insertrow(0)
			end if
		end if
	end if
...
//--- IRR
		if kist_tab_contratti_doc.unita_misura[1] > " " then
			tab_1.tabpage_3.dw_3.setitem(1, "unita_misura", kist_tab_contratti_doc.unita_misura[1] ) 
		else
...
//--- Imposta Misure		
		if isnull(kist_tab_contratti_doc.mis_x[1]) then
			kist_tab_contratti_doc.mis_x[1] = 0
			kist_tab_contratti_doc.mis_y[1] = 0
			kist_tab_contratti_doc.mis_z[1] = 0
		end if
			
		if kist_tab_contratti_doc.mis_x[1] = 0 then
			kuf1_base = create kuf_base
			k_record_base = kuf1_base.prendi_dato_base ("mis_ped")
			destroy kuf_base
			if LeftA(k_record_base,1) = "0" then		
				kist_tab_contratti_doc.mis_x[1] = integer(trim(MidA(k_record_base, 2, 5)))
				kist_tab_contratti_doc.mis_y[1] = integer(trim(MidA(k_record_base, 7, 5)))
				kist_tab_contratti_doc.mis_z[1] = integer(trim(MidA(k_record_base, 12, 5)))
			else
				kist_tab_contratti_doc.mis_x[1] = 0
				kist_tab_contratti_doc.mis_y[1] = 0
				kist_tab_contratti_doc.mis_z[1] = 0
		...
		tab_1.tabpage_3.dw_3.setitem(1, "mis_x_1", kist_tab_contratti_doc.mis_x[1] ) 		
		tab_1.tabpage_3.dw_3.setitem(1, "mis_y_1", kist_tab_contratti_doc.mis_y[1] ) 		
		tab_1.tabpage_3.dw_3.setitem(1, "mis_z_1", kist_tab_contratti_doc.mis_z[1] ) 		
...
//
int k_rc 
boolean k_msg_dopo_update

	
		
	if (ki_st_open_w.flag_modalita = kkg_flag_modalita.modifica &
				or ki_st_open_w.flag_modalita = kkg_flag_modalita.inserimento) &
				and dati_modif_1() then
		if messagebox("Anteprima", "Salvare i dati per fare l'anteprima aggiornata ai cambiamenti?", question!, yesno!, 1) = 1 then
			k_msg_dopo_update = ki_msg_dopo_update
			ki_msg_dopo_update = false
			aggiorna_dati( )
			ki_msg_dopo_update = k_msg_dopo_update
		end if
	end if
		
	if u_dw_4_retrieve( ) > 0 then
		tab_1.tabpage_4.dw_4.resetupdate( )
	else
		messagebox("Anteprima", "Nessun dato da visualizzare ma ricorda di salvare i dati per fare l'anteprima aggiornata!", stopsign!) 
	end if
...
//=== Puntatore Cursore da attesa..... 
	...
	if tab_1.tabpage_1.dw_1.rowcount( ) > 0 then
		kist_tab_contratti_doc.id_contratto_doc = tab_1.tabpage_1.dw_1.getitemnumber(1, "id_contratto_doc")
		if kist_tab_contratti_doc.id_contratto_doc > 0 then
			tab_1.tabpage_4.dw_4.dataobject = kiuf_contratti_doc.get_form_di_stampa(kist_tab_contratti_doc)
			if kist_tab_contratti_doc.form_di_stampa > " " then
				tab_1.tabpage_4.dw_4.settransobject( kguo_sqlca_db_magazzino )
				k_return = tab_1.tabpage_4.dw_4.retrieve(kist_tab_contratti_doc.id_contratto_doc)
				if k_return < 1 then
					kguo_exception.kist_esito.esito = kkg_esito.db_ko
					kguo_exception.kist_esito.sqlerrtext = "Lay-out di stampa della Quotazione non generato " &
																		+ "(errore=" + string(k_return) + ")!"
					throw kguo_exception
				end if
			else
				kguo_exception.kist_esito.esito = kkg_esito.not_fnd
				kguo_exception.kist_esito.sqlerrtext = "Lay-out di stampa della Quotazione non trovato! " + kguo_exception.kist_esito.sqlerrtext
				throw kguo_exception
			end if
		else
			kguo_exception.kist_esito.esito = kkg_esito.dati_wrn
			kguo_exception.kist_esito.sqlerrtext = "Prima di fare l'anteprima occorre salvare il documento! " + kguo_exception.kist_esito.sqlerrtext
			throw kguo_exception
		end if
	end if
		
//--- ripropone eventaulemnete i link
	tab_1.tabpage_4.dw_4.ki_flag_modalita = kkg_flag_modalita.anteprima
...
try
	if ki_tab_1_index_new = 4 then
		...
		kiuf_contratti_doc.stampa_documento_prova(kist_tab_contratti_doc)
...
if ki_tab_1_index_new = 4 then
	m_main.m_finestra.m_fin_stampa.text = "Stampa Anteprima"
	m_main.m_finestra.m_fin_stampa.microhelp = "Stampa Anteprima"
	m_main.m_finestra.m_fin_stampa.toolbaritemText =  "Stampa,Stampa Anteprima"
else
	m_main.m_finestra.m_fin_stampa.text = ki_menu.m_finestra.m_fin_stampa.text 
	m_main.m_finestra.m_fin_stampa.microhelp = ki_menu.m_finestra.m_fin_stampa.microhelp
	m_main.m_finestra.m_fin_stampa.toolbaritemText = ki_menu.m_finestra.m_fin_stampa.toolbaritemText
end if
end subroutine
...
if isvalid(ki_menu) then destroy ki_menu
...
ki_menu = create m_main

end event

type dw_print_0 from w_g_tab_3`dw_print_0 within w_contratti_doc
end type
...
string powertiptext = "Salva i dati prima di fare l~'Anteprima"
ln_1 ln_1
end type
...
integer taborder = 10
boolean enabled = true
string dataobject = "d_contratti_doc_st0_ed190401"
string ki_flag_modalita = "vi"

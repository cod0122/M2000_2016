...
//
	if not m_main.m_strumenti.m_fin_gest_libero1.visible then
		m_main.m_strumenti.m_fin_gest_libero1.text = "Cambia il periodo di estrazione elenco (decorrenza)"
		m_main.m_strumenti.m_fin_gest_libero1.microhelp =  "Cambia periodo di estrazione elenco"
		...
		m_main.m_strumenti.m_fin_gest_libero2.text = "Stampa documenti selezionati"
		m_main.m_strumenti.m_fin_gest_libero2.microhelp =  "Stampa documenti selezionati"
		...
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemText = "Stampa,"+m_main.m_strumenti.m_fin_gest_libero2.text
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemName = "printa16.png"
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritembarindex=2
		
		m_main.m_strumenti.m_fin_gest_libero4.text = "Crea Listino dal Contratto"
		m_main.m_strumenti.m_fin_gest_libero4.microhelp =  "Trasferisci documenti nel Listino"
		...
		m_main.m_strumenti.m_fin_gest_libero4.toolbaritemText = "Crea,"+m_main.m_strumenti.m_fin_gest_libero4.text
		m_main.m_strumenti.m_fin_gest_libero4.toolbaritemName = "Custom079!"
		m_main.m_strumenti.m_fin_gest_libero4.toolbaritembarindex=2
	end if		
	
	
	if not m_main.m_strumenti.m_fin_gest_libero7.visible then
		m_main.m_strumenti.m_fin_gest_libero7.libero1.text = "Mostra Contratti Conto Deposito in Vigore "
		m_main.m_strumenti.m_fin_gest_libero7.libero1.microhelp = "Mostra Contratti in Vigore"
		...
		m_main.m_strumenti.m_fin_gest_libero7.libero1.toolbaritemText = "Validi,"+m_main.m_strumenti.m_fin_gest_libero7.libero1.text
		m_main.m_strumenti.m_fin_gest_libero7.libero1.toolbaritemName = "DataWindow1!"
		m_main.m_strumenti.m_fin_gest_libero7.libero1.toolbaritembarindex=2
	
		m_main.m_strumenti.m_fin_gest_libero7.libero2.text = "Mostra Contratti Conto Deposito Annullati"
		m_main.m_strumenti.m_fin_gest_libero7.libero2.microhelp = "Mostra Contratti Scaduti"
		...
		m_main.m_strumenti.m_fin_gest_libero7.libero2.toolbaritemText = "Annullati,"+m_main.m_strumenti.m_fin_gest_libero7.libero2.text
		m_main.m_strumenti.m_fin_gest_libero7.libero2.toolbaritemName = "DataWindow2!"
		m_main.m_strumenti.m_fin_gest_libero7.libero2.toolbaritembarindex=2
	
		m_main.m_strumenti.m_fin_gest_libero7.libero3.text = "Mostra Tutti i Contratti Conto Deposito"
		m_main.m_strumenti.m_fin_gest_libero7.libero3.microhelp = "Mostra Tutti i Contratti "
		...
		m_main.m_strumenti.m_fin_gest_libero7.libero3.toolbaritemText = "Tutti,"+m_main.m_strumenti.m_fin_gest_libero7.libero3.text
		m_main.m_strumenti.m_fin_gest_libero7.libero3.toolbaritemName = "EditDataTabular!" //"DataWindow5!"
...
type st_duplica from w_g_tab0`st_duplica within w_contratti_dp_l
end type

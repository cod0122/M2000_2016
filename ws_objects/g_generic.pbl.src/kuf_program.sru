...
public function boolean u_update_dev_version (boolean k_update_ask)
...
try
	...
	if not kuf1_utility.u_check_network() then
		...
		kguo_exception.setmessage("Rete non Connessa", "Attenzione, fallito tentatvo di connessione alla rete!! Operazione interrotta!")

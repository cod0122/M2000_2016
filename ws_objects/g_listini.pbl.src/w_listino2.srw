...
//--- data VALIDITA'
				kst_tab_listino.dt_end = tab_1.tabpage_1.dw_1.getitemdate (k_riga, "dt_end")
				if kst_tab_listino.dt_end > kkg.data_no then
					if tab_1.tabpage_1.dw_1.getitemdate (k_riga, "dt_start") > kst_tab_listino.dt_end then
						k_errore = kkg_esito.err_formale
						k_return += "Periodo in Vigore indicato (dal " + string(tab_1.tabpage_1.dw_1.getitemdate (k_riga, "dt_start"), "dd mmm yy") + " al " &
...
type st_duplica from w_listino`st_duplica within w_listino2
end type

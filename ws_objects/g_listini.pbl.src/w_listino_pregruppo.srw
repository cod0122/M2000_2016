...
//--- Attiva/Dis. Voci di menu personalizzate
	...
	if not m_main.m_strumenti.m_fin_gest_libero2.visible then
		...
		m_main.m_strumenti.m_fin_gest_libero2.text = "Genera un nuovo Gruppo Listino come quello selezionato"
		m_main.m_strumenti.m_fin_gest_libero2.microhelp =  "Duplica Gruppo listino"
...
type st_duplica from w_g_tab_3`st_duplica within w_listino_pregruppo
end type

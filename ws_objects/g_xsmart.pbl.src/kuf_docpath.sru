...
public function any get_docpath (string a_doctipo) throws uo_exception
public function any get_docpath_relative (string a_doctipo) throws uo_exception
end prototypes
...
public function any get_docpath (string a_doctipo) throws uo_exception;//----------------------------------------------------------------------
//--- Torna i PATH definiti in tabella per Tipo (kuf_doctipo)
//---
//--- input: kuf1_doctipo.kki_tipo_.....
...
string k_return[20]
long k_righe, k_riga
string k_path[20], k_path_interno, k_path_esterno
st_tab_docpath kst_tab_docpath[]
...
//--- valuto se PATH anche x documento Uso Esterno
		if if_uso_esterno(kst_tab_docpath[1]) then 
...
public function any get_docpath_relative (string a_doctipo) throws uo_exception;//----------------------------------------------------------------------
//--- Torna i PATH RELATIVI INTERNI definiti in tabella per Tipo (kuf_doctipo)
//---
//--- input: kuf1_doctipo.kki_tipo_.....
//--- Rit: string array = path 
//---
...
try
	...
	if kst_tab_docpath[1].id_doctipo > 0 then 
		...
		for k_riga = 1 to k_righe
			...
			k_path[k_riga] = trim(kst_tab_docpath[k_riga].path)

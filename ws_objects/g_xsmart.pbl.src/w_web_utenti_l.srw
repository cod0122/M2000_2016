...
//--- Attiva/Dis. Voci di menu personalizzate
	...
	if not m_main.m_strumenti.m_fin_gest_libero1.visible then
		...
		m_main.m_strumenti.m_fin_gest_libero1.text = "Ruoli Web"
		m_main.m_strumenti.m_fin_gest_libero1.microhelp =  "Ruoli Web"
		...
		m_main.m_strumenti.m_fin_gest_libero1.toolbaritemText = "Ruoli,"+m_main.m_strumenti.m_fin_gest_libero1.text
		m_main.m_strumenti.m_fin_gest_libero1.toolbaritemName = "Ole1!"
		m_main.m_strumenti.m_fin_gest_libero1.toolbaritembarindex=2
		
		m_main.m_strumenti.m_fin_gest_libero2.text = "Cartelle Web"
		m_main.m_strumenti.m_fin_gest_libero2.microhelp =  "Cartelle Web"
		...
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemText = "Cartelle,"+m_main.m_strumenti.m_fin_gest_libero2.text
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritemName =  "Ole2!"
		m_main.m_strumenti.m_fin_gest_libero2.toolbaritembarindex=2
		
		m_main.m_strumenti.m_fin_gest_libero3.text = "Pubblica su Web"
		m_main.m_strumenti.m_fin_gest_libero3.microhelp =  "Trasferimento alle tabelle Web"
		...
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemText = "Pubblica,"+m_main.m_strumenti.m_fin_gest_libero3.text
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemName =  "Destination5!"
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritembarindex=2
		
		m_main.m_strumenti.m_fin_gest_libero4.text = "Ultima Pubblicazione"
		m_main.m_strumenti.m_fin_gest_libero4.microhelp =  "Elenco Utenti ultima pubblicazione"
		...
		m_main.m_strumenti.m_fin_gest_libero4.toolbaritemText = "Vedi Pubb.,"+m_main.m_strumenti.m_fin_gest_libero4.text
		m_main.m_strumenti.m_fin_gest_libero4.toolbaritemName =  "BrowseClasses!"

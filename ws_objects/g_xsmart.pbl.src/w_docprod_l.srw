...
//		
		m_main.m_strumenti.m_fin_gest_libero3.text = "Esporta Documenti"
		m_main.m_strumenti.m_fin_gest_libero3.microhelp =  "Genera documenti elettronici"
		...
		m_main.m_strumenti.m_fin_gest_libero3.toolbaritemText = "Esporta,"+m_main.m_strumenti.m_fin_gest_libero3.text
...
post event ue_buttonclicked("default")
end event
